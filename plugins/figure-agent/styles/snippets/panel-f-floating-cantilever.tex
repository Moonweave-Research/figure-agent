...
\newcommand{\PanelFFloatingCantilever}[2]{%
  \begin{scope}[shift={(#2)}]
    % Stable anchors for semantic overlays and downstream inspection.
    \coordinate (#1FixedBoundary) at (0,0.34);
    \coordinate (#1FloatingCantilever) at (-0.26,0);
    \coordinate (#1DrivenElectrode) at (1.34,-1.40);
    \coordinate (#1SourceReturn) at (1.74,0.39);
    \coordinate (#1TrappedCharge) at (-0.22,-0.56);
