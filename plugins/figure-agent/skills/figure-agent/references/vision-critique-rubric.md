...
This reference contains the detailed rendered-meaning and visual-adjudication
contract for Figure Agent. Read it only through the routing rule in `../SKILL.md`;
it does not replace `docs/figure-agent.md` as product authority.

## Contents

- [L4.5 vision critique](#l45-vision-critique-host-orchestrated)
- [Rendered meaning and domain semantics](#rendered-meaning-and-domain-semantics)
- [Apparatus, materials, and mechanism ownership](#apparatus-materials-and-mechanism-ownership)
- [Cross-panel morphology and process narratives](#cross-panel-morphology-and-process-narratives)
- [Composition, print, and critique evidence](#composition-print-and-critique-evidence)
- [Critique schemas and closeout](#critique-schemas-and-closeout)
...
## Rendered meaning and domain semantics
...
## Apparatus, materials, and mechanism ownership
...
## Cross-panel morphology and process narratives
...
Stale or malformed detector evidence must become an explicit fail-closed refusal
and workflow stop; it must never crash the loop or yield a repair candidate.
...
## Composition, print, and critique evidence
