        ...
        "defects": [
            {
                ...
                "selector_hint": {
                    "kind": "semantic_anchor",
                    "selector_id": "panel_f.label.ispd",
                    "anchor_start": "% figure-agent:start panel_f.label.ispd",
                    "anchor_end": "% figure-agent:end panel_f.label.ispd",
                    "source_hash": file_sha256(source),
                },
                "attribution": {"state": "exact"},
                "protected_invariants": ["panel_f.apparatus_topology"],
                "suggested_change": {
