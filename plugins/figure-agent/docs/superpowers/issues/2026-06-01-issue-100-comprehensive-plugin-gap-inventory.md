...
Status: active roadmap; listed P0-P3 hardening slices implemented through Issue 100BR, with real-fixture SVG polish promotion still evidence-gated
...
- branch baseline: `main` after Issue 100BR TeX coordinate shift suffix boundary;
