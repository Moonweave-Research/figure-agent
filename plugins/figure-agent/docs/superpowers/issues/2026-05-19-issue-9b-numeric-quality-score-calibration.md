...
After Issue 9A has dogfood evidence, decide whether numeric quality scores are
worth adding. If adopted, add advisory non-monotonic `overall_score` and
`sub_scores` to `journal_grade_assessment`.
