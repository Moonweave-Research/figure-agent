% fig1_overview_v5f_v013_dogfood_001_vault — 2-row 7-panel narrative overview
...
\foreach \tx in {4.85, 5.65, 6.25} {
  \draw[cGray!60, line width=0.65pt] (\tx, 5.65) -- (\tx, 5.59);
}
...
\foreach \cx/\cy/\rr in {11.62/2.28/0.075,11.43/1.86/0.082,11.10/1.36/0.088,10.72/0.94/0.082} {
  \draw[cRed!35!white, line width=0.25pt, opacity=0.36] (\cx,\cy) circle ({1.90*\rr});
...
\draw[panelFCoulombRepulsionArrow, -{Stealth[length=8.6pt,width=6.2pt]}, cRed!82!black, line width=1.08pt]
