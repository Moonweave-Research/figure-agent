...
1. `./bin/fig-agent status fig1_overview_v5f_v013_dogfood_001_vault --json`
2. `./bin/fig-agent context-pack fig1_overview_v5f_v013_dogfood_001_vault`
3. source redesign
4. `./bin/fig-agent compile fig1_overview_v5f_v013_dogfood_001_vault`
...
8. `./bin/fig-agent adjudicate fig1_overview_v5f_v013_dogfood_001_vault`
9. `./bin/fig-agent export fig1_overview_v5f_v013_dogfood_001_vault`
