# Element-Iteration Loop Protocol — fig1_overview_v5f_v013_dogfood_001_vault
...
5. `fig1_overview_v5f_v013_dogfood_001_vault.tex` lines for sub-regions in scope (per `briefing.md` §13.`<ID>`)
...
4. `bash scripts/compile.sh examples/fig1_overview_v5f_v013_dogfood_001_vault/fig1_overview_v5f_v013_dogfood_001_vault.tex`
