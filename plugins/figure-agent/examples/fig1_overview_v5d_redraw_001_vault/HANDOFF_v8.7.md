# fig1_overview_v5d_redraw_001_vault — Handoff (v8.7 + 5-iter critique polish)
...
**Working PNG:** `plugins/figure-agent/examples/fig1_overview_v5d_redraw_001_vault/build/fig1_overview_v5d_redraw_001_vault.png`
...
- Run: `cd plugins/figure-agent && uv run python scripts/critique_brief.py examples/fig1_overview_v5d_redraw_001_vault` then host-write fresh `critique.md`
...
```
plugins/figure-agent/examples/fig1_overview_v5d_redraw_001_vault/
├── briefing.md                    # ~770 lines, v8.6 + v8.7 specs locked
├── fig1_overview_v5d_redraw_001_vault.tex   # ~770 lines, v8.7 critique-polished
...
ls -la examples/fig1_overview_v5d_redraw_001_vault/build/

# 2. Fresh compile (should match committed PNG)
bash scripts/compile.sh examples/fig1_overview_v5d_redraw_001_vault/fig1_overview_v5d_redraw_001_vault.tex

# 3. View current PNG
# /Users/choemun-yeong/workspace/ResearchOS/[figure-agent]/plugins/figure-agent/examples/fig1_overview_v5d_redraw_001_vault/build/fig1_overview_v5d_redraw_001_vault.png

# 4. Fresh critique (next gate)
uv run python scripts/critique_brief.py examples/fig1_overview_v5d_redraw_001_vault

# 5. Re-export when ready
uv run python scripts/run_export.py fig1_overview_v5d_redraw_001_vault --skip-critique --force-golden
```
