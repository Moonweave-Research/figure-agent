% fig1_overview_v5d_redraw_001_vault — 2-row 7-panel narrative overview
...
% v5c quiet-editorial candidate: keep only a nearly invisible grouping cue.
% The v5b bracket improved scientific linkage but still read as a tool scaffold
% in the inter-row gap. This version treats the bridge as a hairline editorial
% hint rather than a semantic diagram layer.
\draw[cGray!18, line width=0.25pt, opacity=0.28] (2.275, 4.79) -- (2.275, 4.62);
\draw[cGray!18, line width=0.25pt, opacity=0.28] (11.70, 4.79) -- (11.70, 4.62);
\draw[cGray!18, line width=0.25pt, opacity=0.28] (2.275, 4.79) -- (11.70, 4.79);
...
\draw[-{Stealth[length=2.8pt,width=2.1pt]}, cGray!40!black, line width=0.34pt, opacity=0.72]
  (6.975, 4.79) -- (6.975, 4.98);
...
\node[font=\sffamily\itshape\fontsize{5.1}{6.1}\selectfont, text=cGray!42!black,
      anchor=south, inner sep=0pt] at (6.975, 5.03) {convergent evidence};
