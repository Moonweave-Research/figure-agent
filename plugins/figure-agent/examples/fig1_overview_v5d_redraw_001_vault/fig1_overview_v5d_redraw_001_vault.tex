...
\node[font=\sffamily\itshape\fontsize{5.4}{6.4}\selectfont, text=cGray!55!black,
      anchor=south, inner sep=0pt] at (6.975, 5.00) {convergent evidence};
...
% v5d redraw slice 3: keep the high-n label in a right-hand lane.  The
% previous path-centered placement let the rotated word extend back onto the
% Debye cliff at print scale.  A horizontal right-lane label is less decorative
% but reads more cleanly beside the dashed reference and red trace.
\node[font=\sffamily\bfseries\itshape\fontsize{6.2}{7.4}\selectfont,
      text=cRed!80!black, anchor=west, inner sep=1pt]
  at (3.22, 0.68) {high $n$};
