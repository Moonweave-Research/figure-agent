% fig1_overview_v5a_polish_001_vault — 2-row 7-panel narrative overview
...
% mobility-edge text and red escape curve move out of the same optical lane.
      ...
      text opacity=1, inner xsep=0.8pt, inner ysep=0.35pt] at (12.40, 7.58) {shallow};
\node[font=\sffamily\bfseries\fontsize{6.5}{7.8}\selectfont,
...
\draw[-{Stealth[length=3.2pt,width=2.4pt]}, dashed, cRed!70!black,
      line width=0.35pt] (11.10, 6.20) .. controls (11.08, 6.58) and (11.58, 6.78) .. (11.62, 7.74);
...
\draw[cGray!42, line width=0.30pt] (2.275, 4.85) -- (2.275, 4.56);
\draw[cGray!42, line width=0.30pt] (11.70, 4.85) -- (11.70, 4.56);
\draw[cGray!42, line width=0.30pt] (2.275, 4.85) -- (11.70, 4.85);
...
\draw[-{Stealth[length=3.5pt,width=2.6pt]}, cGray!58!black, line width=0.55pt]
...
\node[font=\sffamily\itshape\fontsize{5.8}{7}\selectfont, text=cGray!52!black,
...
\node[font=\sffamily\fontsize{5.8}{7}\selectfont, text=cGray!62!black,
...
\draw[cGray!11, line width=0.25pt, rounded corners=1.5pt]
  (0.05, 0.04) rectangle (13.85, 4.50);
\draw[cGray!12, line width=0.25pt] (4.62, 0.10) -- (4.62, 4.42);
\draw[cGray!12, line width=0.25pt] (9.47, 0.10) -- (9.47, 4.42);
