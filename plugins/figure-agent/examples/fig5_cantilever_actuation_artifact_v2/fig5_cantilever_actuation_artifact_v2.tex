...
\begin{scope}[shift={(13.35,0.00)}]
  ...
  \node[labelMute,anchor=north east] at (4.00,0.92) {time after $t=0$};
  \node[labelMute,anchor=east] at (0.56,3.63) {$+\theta$};
  \node[labelMute,anchor=east] at (0.56,1.46) {$-\theta$};

  % The response plot begins at a real observation origin.  The 20-minute
  % charge hold is an incoming precondition, not an apparent trace duration.
  \node[labelMute,anchor=west] at (0.76,4.42)
    {precharge: $+5\,\mathrm{kV}$ for 20 min};
  \node[labelStd,anchor=west] at (0.98,3.96) {$t=0$: source OFF};
  \node[labelMute,anchor=west] at (0.98,3.75) {clip floating};
  \draw[cGray!58!black,line width=0.72pt] (0.74,3.62)--(0.94,3.62);
  \draw[cBlue!82!black,line width=1.05pt]
    (0.98,3.62) .. controls (1.16,3.63) and (1.32,3.62) .. (1.46,3.56)
  ...
  \draw[cGray!72!black,line width=0.45pt] (0.98,2.52)--(0.98,2.38);
  \node[labelMute,anchor=north] at (0.98,2.30) {$t=0$};
