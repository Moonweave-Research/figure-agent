# Briefing — fig1_hybrid_complex_panel_pilot

> **Slice 3 hybrid pilot.** This fixture is a new fork of
> `fig1_overview_v2_pair_001_vault` at commit `58cae332`. Panel C delegates
> complex geometry to the declared semantic fragment while TikZ retains global
> composition, every text label, and inter-panel arrows. The inherited prose
> below is source context, not a fresh human review or publication verdict.
