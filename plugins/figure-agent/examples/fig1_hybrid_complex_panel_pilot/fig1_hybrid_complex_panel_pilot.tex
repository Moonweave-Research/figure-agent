% fig1_hybrid_complex_panel_pilot — TikZ composition + semantic SVG geometry
% Forked from fig1_overview_v2_pair_001_vault at source commit 58cae332.
%
...
% Slice 3 hybrid ownership boundary: the generated PDF below owns complex
% geometry only. TikZ retains all labels, global composition, and arrows.
% The original historical Panel C implementation remains below the \else arm
% for provenance and comparison; it is not edited or overwritten.
\newif\ifhybridpanelc
\hybridpanelctrue
\ifhybridpanelc
\node[inner sep=0pt, anchor=center] at (10.45, 7.00)
  {\includegraphics[width=7.00cm,height=4.00cm]{fragments/complex_panel_fragment.pdf}};
\node[labelMute, anchor=north,
      font=\sffamily\itshape\fontsize{6.5}{7.8}\selectfont,
      text=cGray!70!black] at (8.70, 5.98) {poly(S-r-DIB) thin film};
\node[font=\sffamily\fontsize{6}{7.2}\selectfont, text=cGray!80!black,
      anchor=south, rotate=90] at (10.93, 6.55) {Energy};
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!75!black,
      anchor=south] at (12.35, 8.55) {$E_C$};
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!60!black,
      anchor=south] at (12.35, 8.25) {mobility edge};
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!75!black,
      anchor=north] at (12.35, 5.30) {$E_V$};
\node[font=\sffamily\bfseries\fontsize{6.5}{7.8}\selectfont,
      text=cBlue!80!black, anchor=west] at (11.35, 7.38) {shallow};
\node[font=\sffamily\bfseries\fontsize{6.5}{7.8}\selectfont,
      text=cRed!80!black, anchor=west] at (11.60, 5.62) {deep};
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cRed!75!black,
      anchor=west, inner sep=0.5pt] at (13.48, 6.28) {$\Delta E_t$};
...
\node[anchor=south, font=\sffamily\fontsize{6}{7.2}\selectfont,
...
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!60!black,
      anchor=west] at (11.80, 8.07) {mobility edge};
...
% the Delta-E_t vertical caliper while staying off the deep escape curve.
      text=cBlue!80!black, anchor=west] at (12.30, 7.64) {shallow};
\node[font=\sffamily\bfseries\fontsize{6.5}{7.8}\selectfont,
...
% Goal-1 elem-iter [2026-06-04]: arrow tip 5.12 -> 5.02 + head 5/3.5 -> 4/3pt so
% the caption can drop to 5.05 (off row-1) without the tip merging into glyphs.
\draw[-{Stealth[length=4pt,width=3pt]}, cGray!70!black, line width=0.70pt]
...
% Goal-1 elem-iter [2026-06-04]: caption y 5.15 -> 5.05 — user flagged it 'stuck
% against row 1'. Glyph 5.05..5.19; gap to Panel B Sulfur axis label (~5.40) now
% 0.21cm (was 0.11cm). Sits just above the shortened arrow tip (5.02).
...
\path[draw=none] (0.65, 2.30) -- (3.85, 0.55)
  node[pos=0.55, font=\sffamily\bfseries\itshape\fontsize{6.5}{7.8}\selectfont,
       text=cRed!80!black, sloped, below=5pt, inner sep=1pt]
  {high $n$};
