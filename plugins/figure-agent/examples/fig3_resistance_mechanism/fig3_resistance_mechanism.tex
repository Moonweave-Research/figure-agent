...
\coordinate (retained_label_anchor) at ($(trap_deep)+(-0.78,-0.32)$);
\node[anchor=west, font=\fontsize{4.8}{5.6}\selectfont, text=cGray!55!black] at (retained_label_anchor) {retained};
