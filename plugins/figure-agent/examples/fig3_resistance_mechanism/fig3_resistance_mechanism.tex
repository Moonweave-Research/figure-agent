...
\node[anchor=north west, fill=white, inner sep=0.4pt,
  font=\fontsize{4.4}{5.2}\selectfont, text=cGray!55!black]
  (slow_release_label) at (3.96,1.96) {slow-release};
...
\begin{scope}
  ...
  % A continuous support region, not a fitted density-of-states envelope.
  \fill[cRed!18, rounded corners=1.15mm] (12.52,1.46) rectangle (13.98,3.07);
  \draw[cRed!58!black, line width=0.45pt, rounded corners=1.15mm]
    (12.52,1.46) rectangle (13.98,3.07);
