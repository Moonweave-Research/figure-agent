...
% The lower outcome strip belongs to panel A; it is not a floating inter-panel inset.
\draw[cGray!25, line width=0.25pt] (0.72,0.86) -- (4.62,0.86);
\node[lbl, anchor=west, font=\fontsize{5.0}{6.2}\selectfont] at (0.55,0.48)
  {trapping $\rightarrow$ current $\downarrow$, $R\uparrow$};
% fig-agent:start object=current_sparkline panel=A kind=inset_plot truth_bearing=true
\draw[-{Stealth[length=0.6mm]}, line width=0.3pt] (3.68,0.18) -- (4.38,0.18);
\draw[-{Stealth[length=0.6mm]}, line width=0.3pt] (3.68,0.18) -- (3.68,0.68);
\draw[cGray!72!black, line width=0.5pt] plot[smooth, domain=0:0.92, samples=32]
  ({3.68+0.72*\x},{0.18+0.43*exp(-3.2*\x)});
\node[font=\fontsize{3.8}{4.5}\selectfont, anchor=north] at (4.38,0.14) {$t$};
\node[font=\fontsize{3.8}{4.5}\selectfont, anchor=south] at (4.03,0.70) {$I(t)$};
...
\begin{scope}[shift={(6.3,1.05)}]
  ...
  % fig-agent:start object=s60_discrete_states panel=B kind=distribution truth_bearing=true
  % Representative state sticks show a discrete set; their count and heights are illustrative,
  % not a measured peak-count claim.
  \foreach \x/\h in {0.66/0.72,1.10/1.85,1.54/0.84}{
    \draw[cBlue!65!black, line width=0.85pt, line cap=round] (\x,0) -- (\x,\h);
  }
  % fig-agent:end object=s60_discrete_states
  % fig-agent:start object=s80_continuous_distribution panel=B kind=distribution truth_bearing=true
