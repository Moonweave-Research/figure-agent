% Fig3 mechanism schematic — maintained development baseline.
% Human-reviewed post-baseline detail and label-clearance refinement.
...
% Panel A — applied-bias trapping mechanism
...
\node[anchor=north, font=\fontsize{4.8}{5.8}\selectfont, text=cAmber!68!black]
  (slow_release_label) at (slow_release_label_anchor) {slow-release};
% fig-agent:end object=carrier_sequence

% Panel B — qualitative transient response
...
% Panel C — shared vertical energy-landscape grammar
...
\begin{scope}
  \fill[cBlue!4, rounded corners=0.8pt] (10.10,1.23) rectangle (11.60,3.25);
  \draw[cBlue!24!white, line width=0.30pt, rounded corners=0.8pt] (10.10,1.23) rectangle (11.60,3.25);
...
\end{scope}
\begin{scope}
  \fill[cRed!4, rounded corners=0.8pt] (12.16,1.23) rectangle (14.34,3.25);
  \draw[cRed!24!white, line width=0.30pt, rounded corners=0.8pt] (12.16,1.23) rectangle (14.34,3.25);
  ...
  \foreach \y/\x/\len in {
    ...
    2.87/13.89/0.25,2.99/13.28/0.44,3.11/12.60/0.28,3.03/13.70/0.34}{
