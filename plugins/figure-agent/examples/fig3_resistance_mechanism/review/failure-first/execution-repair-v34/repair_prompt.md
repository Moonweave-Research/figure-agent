...
- The controller will materialize a validated candidate at [examples/fig3_resistance_mechanism/review/failure-first/execution-repair-v34/repaired_generated.tex].
...
- Machine finding: {"finding": "retained reads as a detached white box over the path instead of belonging to the filled endpoint carrier", "id": "HF016", "subject": "panel_a_retained_label_ownership"}
