...
- The controller will materialize a validated candidate at [examples/fig3_resistance_mechanism/review/failure-first/execution-repair-v41/repaired_generated.tex].
...
- Machine finding: {"finding": "rotated g(E) remains visually attached to the arrow, so use a horizontal ordinate label above-left of the y-axis tip", "id": "HF023", "subject": "panel_b_ge_horizontal_ordinate_retry"}
