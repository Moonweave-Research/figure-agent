...
\draw[draw=cBlue, line width=0.95pt, -{Stealth}]
  (1.08,1.62) .. controls (1.12,1.78) and (1.23,1.96) .. (1.34,2.02) .. controls (1.55,2.19) and (1.39,2.87) .. (1.61,3.03)
  .. controls (1.84,3.16) and (2.08,2.73) .. (2.31,2.59) .. controls (2.49,2.45) and (2.48,2.08) .. (2.68,1.98)
  .. controls (2.94,1.88) and (2.94,2.73) .. (3.02,3.02);

\node[carrier] at (1.08,1.62) {};
% Intermediate trap contacts remain encoded by the red site marks.
\node[carrier, fill=cBlue!18] at (3.02,3.02) {};
\node[compact label, align=center, anchor=north] at (1.92,1.03)
  {one carrier path over time\\trap contacts: capture/release; solid end: retained};
...
\begin{scope}[shift={(6.58,0.86)}]
  ...
  \node[compact label, anchor=south] at (0,2.93) {$g(E)$};
  ...
  \node[label, text=cBlue, font=\sffamily\bfseries\footnotesize] at (0.965,2.22) {S60};
  % single discrete state
  \node[compact label, align=center] at (0.965,1.68) {single discrete\\state};
  ...
  \draw[draw=cTeal, line width=0.65pt] (2.23,-0.16)--(4.50,-0.16) (2.23,-0.23)--(2.23,-0.09) (4.50,-0.23)--(4.50,-0.09);
  \node[compact label, text=cTeal, anchor=north] at (3.365,-0.27) {distribution breadth};

  \draw[draw=cBrown, line width=0.65pt, {Stealth}-{Stealth}] (4.78,0.18)--(4.78,1.35);
  \node[compact label, text=cBrown, anchor=west, fill=white, inner sep=1.4pt] at (4.93,1.24) {$\rho_{60\mathrm{s}}$};
