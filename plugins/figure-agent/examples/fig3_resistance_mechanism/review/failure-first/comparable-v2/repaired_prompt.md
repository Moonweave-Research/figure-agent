...
- Write exactly one new source to [plugins/figure-agent/examples/fig3_resistance_mechanism/review/failure-first/comparable-v2/repaired_generated.tex].
- Do not create an intermediate subdirectory beneath [plugins/figure-agent/examples/fig3_resistance_mechanism/review/failure-first/comparable-v2].
