...
\begin{scope}[shift={(6.58,0.86)}]
  ...
  \draw[draw=cTeal, line width=0.55pt] (2.23,-0.18)--(4.50,-0.18);
  \draw[draw=cTeal, line width=0.55pt] (2.23,-0.10)--(2.23,-0.26) (4.50,-0.10)--(4.50,-0.26);
  \node[compact label, text=cTeal] at (3.365,-0.40) {distribution breadth};
