...
- The controller will materialize a validated candidate at [examples/fig3_resistance_mechanism/review/failure-first/execution-repair-v58/repaired_generated.tex].
...
- Machine finding: {"finding": "replace the path, endpoint glyph set, and explanatory key as one contiguous semantic block so a single time-ordered carrier trajectory is visually unambiguous", "id": "HF040", "subject": "panel_a_single_carrier_temporal_path_coupled_retry"}
