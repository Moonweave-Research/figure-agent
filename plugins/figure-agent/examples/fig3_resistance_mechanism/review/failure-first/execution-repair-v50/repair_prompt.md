...
- The controller will materialize a validated candidate at [examples/fig3_resistance_mechanism/review/failure-first/execution-repair-v50/repaired_generated.tex].
...
- Machine finding: {"finding": "widen the central clearance gap enough for the longer distribution breadth label", "id": "HF032", "subject": "panel_b_distribution_breadth_wide_gap_retry"}
