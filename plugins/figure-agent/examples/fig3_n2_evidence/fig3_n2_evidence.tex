...
% Axes + ticks + labels (Panel 1: log-log power-law)
\LogLogPlot{1.92,5.55,3.98,7.15}
  {1.92,2.263,2.607,2.950,3.293,3.637,3.980}
  {1.92/{10^{-3}}, 2.263/{10^{-2}}, 2.607/{10^{-1}}, 2.950/{10^{0}}, 3.293/{10^{1}}, 3.637/{10^{2}}, 3.980/{10^{3}}}
  {5.55,5.858,6.166,6.474,6.782,7.090}
  {5.55/{10^{-4}}, 5.858/{10^{-3}}, 6.166/{10^{-2}}, 6.474/{10^{-1}}, 6.782/{10^{0}}, 7.090/{10^{1}}}
  {$\log\,t$}{$\log\,I$}
...
% Axes + ticks + labels (Panel 3: Debye decay)
\LogLogPlot{1.85,0.97,3.83,2.55}
  {1.85,2.18,2.51,2.84,3.17,3.50,3.83}
  {1.85/{10^{-3}}, 2.18/{10^{-2}}, 2.51/{10^{-1}}, 2.84/{10^{0}}, 3.17/{10^{1}}, 3.50/{10^{2}}, 3.83/{10^{3}}}
  {0.97,1.30,1.63,1.96,2.30}
  {0.97/{10^{-3}}, 1.30/{10^{-2}}, 1.63/{10^{-1}}, 1.96/{10^{0}}, 2.30/{10^{1}}}
  {$\log\,t$}{$\log$ response}
...
% NOTE: hand-tuned Bezier matched to ISPD reference image; \BellCurve side
% formula produces a visibly different curve. Migration deferred (same as
% panel 2 lobes above).
\fill[cAmber!28]
  (12.25, 4.17)
...
% Deep g(Et) Gaussian (cBlue!45!cRed fill, no text label — same reason); same shape caveat
\fill[cBlue!45!cRed!22]
  (12.25, 2.91)
