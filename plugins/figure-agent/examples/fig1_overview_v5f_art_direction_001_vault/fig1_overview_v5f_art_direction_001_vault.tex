...
\fill[cBlue!12, opacity=0.20, rounded corners=1pt] (10.38, 7.18) rectangle (13.55, 7.82);
\fill[cRed!12, opacity=0.18, rounded corners=1pt] (10.38, 5.55) rectangle (13.55, 6.55);
...
% Compact bias source, demoted to support role but redrawn as a real faceplate.
\fill[cGray!35!black, opacity=0.16, rounded corners=1.4pt]
  (12.61, 3.53) rectangle (13.59, 4.14);
\fill[cGray!7, rounded corners=1.4pt] (12.55, 3.58) rectangle (13.53, 4.18);
\draw[cGray!62!black, line width=0.36pt, rounded corners=1.4pt]
  (12.55, 3.58) rectangle (13.53, 4.18);
\draw[cGray!35!black, line width=0.18pt, rounded corners=0.9pt]
  (12.62, 3.65) rectangle (13.46, 4.11);
\fill[cGray!72!black, rounded corners=0.7pt] (12.72, 3.93) rectangle (13.36, 4.06);
\draw[cGray!88!black, line width=0.14pt, rounded corners=0.7pt]
  (12.72, 3.93) rectangle (13.36, 4.06);
\draw[cGray!12, line width=0.46pt]
  (12.78, 3.97) -- (12.89, 3.97) -- (12.89, 4.03)
              -- (13.09, 4.03) -- (13.09, 3.97) -- (13.30, 3.97);
\node[font=\sffamily\bfseries\fontsize{5.6}{6.7}\selectfont, text=cGray!78!black]
  at (13.04, 3.77) {$V_{\mathrm{active}}$};
\fill[cGray!85!black] (13.53, 3.84) circle (0.022);
\fill[cGray!45!black] (13.53, 3.84) circle (0.010);
\draw[cGray!70!black, line width=0.30pt]
  (13.53, 3.84) -- (13.70, 3.84) -- (13.70, 2.82) -- (13.40, 2.82);
...
\foreach \dx in {0,0.11,0.22,0.33,0.44,0.55,0.66} {
  \draw[cGray!55!black, line width=0.24pt]
...
\draw[cGray!45!black, line width=0.20pt] (13.23, 0.50) -- (13.23, 2.78);
\foreach \hy in {0.58,0.74,0.90,1.06,1.22,1.38,1.54,1.70,1.86,2.02,2.18,2.34,2.50,2.66} {
  \draw[cGray!60!black, line width=0.20pt] (13.42, \hy) -- (13.18, {\hy-0.06});
}
\foreach \yy in {0.92,1.22,1.52,1.82,2.12,2.42} {
  \draw[cGray!25, line width=0.24pt, dash pattern=on 1.2pt off 1.5pt]
    (11.08,\yy) -- (13.18,\yy);
}
...
\foreach \cx/\cy/\rr in {11.62/2.28/0.075,11.43/1.86/0.082,11.10/1.36/0.088,10.72/0.94/0.082} {
  \draw[cRed!35!white, line width=0.24pt, opacity=0.42] (\cx,\cy) circle ({1.45*\rr});
  \shade[ball color=cRed!72!black] (\cx,\cy) circle (\rr);
  \draw[cRed!95!black, line width=0.24pt] (\cx,\cy) circle (\rr);
}
\draw[cRed!50!black, line width=0.25pt]
  (11.62,2.28) .. controls (11.84,2.40) and (12.00,2.56) .. (12.18,2.66);
\draw[cRed!45!black, line width=0.24pt]
  (11.10,1.36) .. controls (11.52,1.78) and (11.80,2.24) .. (12.18,2.51);
\node[anchor=west, align=left, fill=white, fill opacity=0.97, text opacity=1,
      inner xsep=1.3pt, inner ysep=0.7pt,
      font=\sffamily\bfseries\fontsize{5.5}{6.8}\selectfont, text=cRed!76!black]
  at (12.16, 2.74) {trapped\\[-0.2pt]charge};
\node[anchor=west, fill=white, fill opacity=0.97, text opacity=1,
      inner xsep=1.0pt, inner ysep=0.5pt,
      font=\sffamily\itshape\fontsize{5.3}{6.4}\selectfont, text=cRed!76!black]
  at (12.25, 2.50) {$q_{\mathrm{tr}}$};

% Coulomb-only response, intentionally stronger than the apparatus.
\draw[panelFCoulombRepulsionArrow, -{Stealth[length=7pt,width=5pt]}, cRed!82!black, line width=0.82pt]
  (10.95, 1.18) -- (9.74, 1.18);
\node[font=\sffamily\bfseries\fontsize{7}{8.4}\selectfont, text=cRed!82!black,
      anchor=south west] at (9.68, 1.55) {Coulomb};
\node[labelMute, anchor=north west, fill=white, fill opacity=0.94, text opacity=1,
      inner xsep=1.2pt, inner ysep=0.6pt,
      font=\sffamily\fontsize{6.4}{7.7}\selectfont,
      text=cRed!82!black] at (9.70, 1.46) {repulsion};
