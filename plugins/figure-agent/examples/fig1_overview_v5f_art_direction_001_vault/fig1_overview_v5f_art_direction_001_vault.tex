...
% Compact bias source, demoted to support role.
\fill[cGray!6, rounded corners=1pt] (12.72, 3.62) rectangle (13.48, 4.12);
\draw[cGray!58!black, line width=0.28pt, rounded corners=1pt]
  (12.72, 3.62) rectangle (13.48, 4.12);
\draw[cGray!35!black, line width=0.16pt, rounded corners=0.8pt]
  (12.78, 3.68) rectangle (13.42, 4.06);
\fill[cGray!72!black, rounded corners=0.6pt] (12.86, 3.91) rectangle (13.34, 4.02);
\draw[cGray!85!black, line width=0.12pt, rounded corners=0.6pt]
  (12.86, 3.91) rectangle (13.34, 4.02);
\draw[cGray!12, line width=0.42pt]
  (12.90, 3.94) -- (12.99, 3.94) -- (12.99, 4.00)
              -- (13.16, 4.00) -- (13.16, 3.94) -- (13.30, 3.94);
\node[font=\sffamily\bfseries\fontsize{5.5}{6.6}\selectfont, text=cGray!78!black]
  at (13.10, 3.76) {$V_{\mathrm{active}}$};
\fill[cGray!80!black] (13.48, 3.82) circle (0.020);
\draw[cGray!70!black, line width=0.25pt]
  (13.48, 3.82) -- (13.62, 3.82) -- (13.62, 2.82) -- (13.40, 2.82);
...
\fill[cGray!25] (13.18, 0.46) rectangle (13.40, 2.82);
\draw[cGray!85!black, line width=0.50pt] (13.18, 0.46) rectangle (13.40, 2.82);
\foreach \hy in {0.58,0.74,0.90,1.06,1.22,1.38,1.54,1.70,1.86,2.02,2.18,2.34,2.50,2.66} {
  \draw[cGray!60!black, line width=0.20pt] (13.40, \hy) -- (13.18, {\hy-0.06});
}
...
\node[labelMute, anchor=south, rotate=270,
      font=\sffamily\fontsize{6.2}{7.4}\selectfont, text=cGray!78!black]
  at (13.62, 1.62) {electrode};
\draw[cGray!70!black, fill=cGray!50!black, line width=0.34pt]
  (13.22, 0.40) -- (13.36, 0.40) -- (13.29, 0.24) -- cycle;
\draw[cGray!70!black, line width=0.26pt] (13.23, 0.21) -- (13.35, 0.21);
\draw[cGray!70!black, line width=0.26pt] (13.26, 0.17) -- (13.32, 0.17);
...
\draw[cRed!50!black, line width=0.28pt]
  (11.62,2.28) .. controls (11.92,2.30) and (12.08,2.38) .. (12.24,2.46);
\draw[cRed!45!black, line width=0.24pt]
  (11.10,1.36) .. controls (11.54,1.70) and (11.84,2.04) .. (12.24,2.34);
\node[anchor=west, align=left, fill=white, fill opacity=0.94, text opacity=1,
      inner xsep=1.1pt, inner ysep=0.55pt,
      font=\sffamily\bfseries\fontsize{5.7}{7.1}\selectfont, text=cRed!76!black]
  at (12.18, 2.42) {trapped\\[0.1pt]charge\\[0.1pt]$q_{\mathrm{tr}}$};
...
\draw[panelFCoulombRepulsionArrow, -{Stealth[length=7pt,width=5pt]}, cRed!82!black, line width=0.82pt]
  (11.42, 1.34) -- (10.25, 1.34);
\node[font=\sffamily\bfseries\fontsize{7}{8.4}\selectfont, text=cRed!82!black,
      anchor=south west] at (10.55, 1.42) {Coulomb};
\node[labelMute, anchor=north west, font=\sffamily\fontsize{6.4}{7.7}\selectfont,
      text=cRed!82!black] at (10.55, 1.30) {repulsion};

\draw[<->, cGray!55!black, line width=0.30pt]
  (10.58, 0.50) -- (13.18, 0.50);
\node[labelMute, anchor=north, inner sep=1pt,
      font=\sffamily\fontsize{6.4}{7.7}\selectfont, text=cGray!75!black]
  at (11.88, 0.45) {air gap};
