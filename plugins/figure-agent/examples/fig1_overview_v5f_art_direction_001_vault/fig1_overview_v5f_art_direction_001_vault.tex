...
% Compact bias module: clean support cue, visually secondary to the mechanism.
\fill[cGray!35!black, opacity=0.06, rounded corners=1.5pt]
  (12.64, 3.52) rectangle (13.62, 4.12);
\fill[cGray!4, rounded corners=1.5pt] (12.58, 3.59) rectangle (13.56, 4.19);
\draw[cGray!62!black, line width=0.30pt, rounded corners=1.5pt]
  (12.58, 3.59) rectangle (13.56, 4.19);
\fill[cGray!82!black, rounded corners=0.8pt] (12.70, 3.96) rectangle (13.18, 4.08);
\draw[cGray!88!black, line width=0.25pt, rounded corners=0.8pt]
  (12.70, 3.96) rectangle (13.18, 4.08);
\draw[cGray!12, line width=0.34pt]
  (12.76, 4.01) -- (12.88, 4.01) -- (12.88, 4.05)
              -- (13.02, 4.05) -- (13.02, 4.01) -- (13.12, 4.01);
\node[font=\sffamily\bfseries\fontsize{4.0}{4.8}\selectfont, text=cGray!76!black]
  at (13.07, 3.81) {$V_{\mathrm{active}}$};
\node[font=\sffamily\fontsize{3.2}{3.9}\selectfont, text=cGray!56!black]
  at (13.07, 3.68) {bias};
\fill[cRed!70!black] (13.32, 4.00) circle (0.025);
\fill[cGray!55!black] (13.44, 4.00) circle (0.025);
\draw[cGray!68!black, line width=0.28pt]
  (13.32, 4.00) -- (13.70, 4.00) -- (13.70, 2.86) -- (13.40, 2.86);
...
\draw[cRed!45!black, line width=0.22pt]
  (11.66,2.35) .. controls (11.70,2.43) and (11.72,2.49) .. (11.76,2.54);
\node[anchor=west, fill=white, fill opacity=0.97, text opacity=1,
      inner xsep=1.1pt, inner ysep=0.55pt,
      font=\sffamily\bfseries\fontsize{4.1}{4.9}\selectfont, text=cRed!76!black]
  at (11.76, 2.55) {$q_{\mathrm{tr}}$ trapped charge};
