...
\node[font=\sffamily\bfseries\fontsize{3.9}{4.7}\selectfont, text=cGray!60!black]
  at (13.00, 3.96) {$V_{\mathrm{active}}$};
\node[font=\sffamily\fontsize{3.0}{3.6}\selectfont, text=cGray!42!black]
  at (13.00, 3.86) {bias};
\fill[cRed!68!black] (13.30, 3.82) circle (0.020);
\fill[cGray!55!black] (13.30, 2.82) circle (0.020);
\draw[cGray!52!black, line width=0.22pt, dash pattern=on 1.2pt off 0.9pt, rounded corners=1.0pt]
...
\foreach \cx/\cy/\rr in {11.62/2.28/0.075,11.43/1.86/0.082,11.10/1.36/0.088,10.72/0.94/0.082} {
  \draw[cRed!35!white, line width=0.25pt, opacity=0.36] (\cx,\cy) circle ({2.35*\rr});
...
\node[anchor=west, fill=white, fill opacity=0.96, text opacity=1,
      ...
      font=\sffamily\bfseries\fontsize{4.2}{5.0}\selectfont, text=cRed!76!black]
...
\draw[panelFCoulombRepulsionArrow, -{Stealth[length=9.6pt,width=6.8pt]}, cRed!82!black, line width=1.24pt]
