...
\node[font=\sffamily\fontsize{5.3}{6.3}\selectfont, text=cGray!50!black,
      fill=white, inner xsep=1.1pt, inner ysep=0.35pt, anchor=north] at (6.975, 4.43) {ISPD};
\node[font=\sffamily\fontsize{5.3}{6.3}\selectfont, text=cGray!50!black,
...
\draw[cGray!85!black, dashed, line width=0.65pt, line cap=round, line join=round]
  (0.65, 2.30) -- (1.62, 2.30)
  .. controls (1.82, 2.28) and (1.82, 0.80) .. (1.88, 0.55);
...
\draw[cGray!65!black, line width=0.22pt] (5.9, 1.35) -- (7, 1.35);
