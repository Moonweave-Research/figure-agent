...
\node[anchor=south, font=\sffamily\bfseries\fontsize{3.5}{4.2}\selectfont, text=cGray!58!black]
  at (13.03, 4.20) {$V_{\mathrm{active}}$};
\node[anchor=north, font=\sffamily\fontsize{2.8}{3.3}\selectfont, text=cGray!42!black]
  at (13.03, 3.74) {bias};
