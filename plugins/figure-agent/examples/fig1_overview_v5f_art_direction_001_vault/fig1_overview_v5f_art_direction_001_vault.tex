...
\node[font=\sffamily\bfseries\fontsize{3.9}{4.7}\selectfont, text=cGray!74!black]
  at (13.06, 3.82) {$V_{\mathrm{active}}$};
\node[font=\sffamily\fontsize{3.0}{3.6}\selectfont, text=cGray!54!black]
  at (13.06, 3.70) {bias};
\fill[cRed!68!black] (13.31, 4.01) circle (0.020);
\fill[cGray!55!black] (13.42, 4.01) circle (0.020);
\draw[cGray!60!black, line width=0.24pt]
  (13.31, 4.01) -- (13.69, 4.01) -- (13.69, 2.86) -- (13.40, 2.86);
...
\draw[cRed!45!black, line width=0.22pt]
  (11.66,2.35) .. controls (11.70,2.43) and (11.73,2.50) .. (11.79,2.55);
