...
% Compact bias source: small but instrument-like, with the mechanism still dominant.
\fill[cGray!35!black, opacity=0.08, rounded corners=1.2pt]
  (12.58, 3.54) rectangle (13.62, 4.14);
\fill[cGray!6, rounded corners=1.2pt] (12.52, 3.59) rectangle (13.56, 4.19);
\draw[cGray!64!black, line width=0.28pt, rounded corners=1.2pt]
  (12.52, 3.59) rectangle (13.56, 4.19);
\draw[cGray!28!black, line width=0.25pt] (12.59, 3.69) -- (13.49, 3.69);
\fill[cGray!78!black, rounded corners=0.7pt] (12.68, 3.94) rectangle (13.16, 4.06);
\draw[cGray!88!black, line width=0.25pt, rounded corners=0.7pt]
  (12.68, 3.94) rectangle (13.16, 4.06);
\draw[cGray!12, line width=0.38pt]
  (12.73, 3.99) -- (12.83, 3.99) -- (12.83, 4.03)
              -- (12.98, 4.03) -- (12.98, 3.99) -- (13.10, 3.99);
\fill[cRed!70!black] (13.31, 3.99) circle (0.025);
\fill[cGray!55!black] (13.43, 3.99) circle (0.025);
\draw[cGray!55!black, line width=0.25pt] (12.64, 3.76) -- (13.45, 3.76);
\node[font=\sffamily\bfseries\fontsize{4.8}{5.8}\selectfont, text=cGray!78!black]
  at (13.04, 3.82) {$V_{\mathrm{active}}$};
\node[font=\sffamily\fontsize{3.6}{4.3}\selectfont, text=cGray!58!black]
  at (12.91, 3.64) {DC bias};
\draw[cGray!68!black, line width=0.28pt]
  (13.31, 3.99) -- (13.70, 3.99) -- (13.70, 2.82) -- (13.40, 2.82);
...
\draw[cGray!86!black, line width=0.72pt] (13.18, 0.46) rectangle (13.42, 2.82);
...
\foreach \cx/\cy/\rr in {11.62/2.28/0.075,11.43/1.86/0.082,11.10/1.36/0.088,10.72/0.94/0.082} {
  \draw[cRed!35!white, line width=0.25pt, opacity=0.42] (\cx,\cy) circle ({1.85*\rr});
  \shade[ball color=cRed!78!black] (\cx,\cy) circle (\rr);
  \draw[cRed!95!black, line width=0.25pt] (\cx,\cy) circle (\rr);
}
\draw[cRed!48!black, line width=0.25pt]
  (11.62,2.28) .. controls (11.78,2.58) and (11.94,2.88) .. (12.15,3.05);
\draw[cRed!42!black, line width=0.25pt]
  (11.10,1.36) .. controls (11.46,1.90) and (11.78,2.55) .. (12.15,2.96);
\node[anchor=west, fill=white, fill opacity=0.97, text opacity=1,
  ...
  at (12.13, 3.08) {$q_{\mathrm{tr}}$ trapped charge};

% Coulomb-only response, intentionally stronger than the apparatus.
\draw[panelFCoulombRepulsionArrow, -{Stealth[length=8.5pt,width=6.2pt]}, cRed!82!black, line width=1.08pt]
  (11.08, 1.18) -- (9.54, 1.18);
