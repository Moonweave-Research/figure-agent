...
\node[font=\sffamily\bfseries\fontsize{3.9}{4.7}\selectfont, text=cGray!58!black]
...
\draw[cGray!48!black, line width=0.20pt, dash pattern=on 1.0pt off 1.0pt, rounded corners=0.7pt]
...
\foreach \cx/\cy/\rr in {11.62/2.28/0.075,11.43/1.86/0.082,11.10/1.36/0.088,10.72/0.94/0.082} {
  \draw[cRed!35!white, line width=0.25pt, opacity=0.26] (\cx,\cy) circle ({2.05*\rr});
