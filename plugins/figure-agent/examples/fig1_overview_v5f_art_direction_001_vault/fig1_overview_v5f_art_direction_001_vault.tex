...
\draw[panelFCoulombRepulsionArrow, -{Stealth[length=7.0pt,width=4.8pt]}, cRed!76!black, line width=0.74pt]
  (10.66, 1.06) -- (9.58, 1.06);
\node[anchor=south west, fill=white, fill opacity=0.92, text opacity=1,
      inner xsep=0.90pt, inner ysep=0.42pt,
      font=\sffamily\bfseries\fontsize{5.0}{6.0}\selectfont, text=cRed!74!black]
