...
\foreach \cx/\cy/\rr in {11.62/2.28/0.075,11.43/1.86/0.082,11.10/1.36/0.088,10.72/0.94/0.082} {
  \draw[cRed!35!white, line width=0.25pt, opacity=0.36] (\cx,\cy) circle ({1.65*\rr});
...
\node[anchor=west, fill=white, fill opacity=0.97, text opacity=1,
      ...
      font=\sffamily\bfseries\fontsize{4.5}{5.4}\selectfont, text=cRed!76!black]
  at (12.10, 3.08) {$q_{\mathrm{tr}}$ trapped charge};

% Coulomb-only response, intentionally stronger than the apparatus.
\draw[panelFCoulombRepulsionArrow, -{Stealth[length=7.6pt,width=5.6pt]}, cRed!82!black, line width=0.94pt]
