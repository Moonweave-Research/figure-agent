# Fig 1 Caption — fig1_overview_v5f_art_direction_001_vault

> Companion text for the figure file `fig1_overview_v5f_art_direction_001_vault.pdf`.
...
- ✅ RESOLVED 2026-06-07: Panel **d** low-*n* control = PDMS/PET (PI excluded — trap-rich, *n*≈0.745, close to sulfur, so not a valid low-*n* contrast). Panel **e** "1.86×" ratio was schematic (not measured) → caption reworded to "deep dominant (schematic)," quantitative params → Fig 3.
