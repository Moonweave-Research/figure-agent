...
| TG-G-001 | BLOCKER | Panel G is Coulomb-only; Maxwell attraction and actuator framing are absent. | Source/render text and arrow review. | Pass for this loop: `briefing.md` invariant 8.5 and contract forbid Maxwell transfer; fresh critique found no BLOCKER/MAJOR Panel G mechanics finding. |
