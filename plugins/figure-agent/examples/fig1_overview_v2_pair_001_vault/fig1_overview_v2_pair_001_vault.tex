...
\node[font=\sffamily\fontsize{5}{5.7}\itshape\selectfont, text=cGray!75!black,
  ...
  at (2.50, 8.20) {inverse\\vulcanization};
...
\draw[cGray!55!black, line width=0.30pt] (2.50, 0.55) -- (2.70, 0.40);
...
\draw[cGray!75!black, line width=0.28pt] (7.85, 3.30) -- (7.95, 3.30) -- (7.95, 3.10);
\draw[cGray!75!black, line width=0.32pt] (7.88, 3.10) -- (8.02, 3.10);
\draw[cGray!75!black, line width=0.28pt] (7.90, 3.07) -- (8.00, 3.07);
\draw[cGray!75!black, line width=0.25pt] (7.92, 3.04) -- (7.98, 3.04);
...
\shade[top color=cGray!4, bottom color=cGray!22]
  (6.225, 4.00) rectangle (6.875, 4.30);
\draw[cGray!60!black, line width=0.22pt]
  (6.225, 4.00) rectangle (6.875, 4.30);
% Inset display window — iter 37: nudged up 0.01cm (4.20→4.21) for symmetric
% gap from box top (4.30 - 4.28 = 0.02cm) and label clearance below.
\fill[cGray!18] (6.30, 4.21) rectangle (6.80, 4.28);
\draw[cGray!55!black, line width=0.15pt]
  (6.30, 4.21) rectangle (6.80, 4.28);
\draw[cGray!75!black, line width=0.40pt]
  (6.33, 4.235) -- (6.42, 4.235) -- (6.42, 4.275)
              -- (6.55, 4.275) -- (6.55, 4.235) -- (6.68, 4.235)
              -- (6.68, 4.275) -- (6.77, 4.275);
% HV+ label below display — iter 36: 6→5pt + y 4.075 → 4.10 (label zone center
% 4.00..4.20, mid y=4.10). Gap from box bottom 4.00 = 0.07cm (was 0.04cm).
\node[font=\sffamily\bfseries\fontsize{5}{6}\selectfont, text=cGray!88!black]
  at (6.55, 4.10) {HV+};
% Output terminal (bottom-center, where wire exits)
\fill[cGray!85!black] (6.55, 4.00) circle (0.022);
\fill[cGray!50!black] (6.55, 4.00) circle (0.011);
% Wire from terminal to needle cuff
\draw[cGray!75!black, line width=0.32pt] (6.55, 4.00) -- (6.55, 3.95);
% Corona needle electrode — iter 16: tip y=3.55 → 3.63 (above new polymer
% top y=3.60). Wedge geometry preserved, just shifted to land on thicker film.
\shade[left color=cGray!75!black, right color=cGray!90!black]
  (6.535, 3.95) -- (6.565, 3.95) -- (6.55, 3.63) -- cycle;
\draw[cGray!90!black, line width=0.22pt]
  (6.535, 3.95) -- (6.565, 3.95) -- (6.55, 3.63) -- cycle;
% Support cuff at top of needle (wire attachment point)
\fill[cGray!85!black] (6.55, 3.95) circle (0.045);
% Spark endpoints land on new polymer top edge y=3.60 (was 3.52).
\draw[cRed!65!black, line width=0.42pt] (6.55, 3.63) -- (6.46, 3.60);  % WSW
\draw[cRed!65!black, line width=0.42pt] (6.55, 3.63) -- (6.50, 3.60);  % SW
\draw[cRed!65!black, line width=0.42pt] (6.55, 3.63) -- (6.55, 3.59);  % S
\draw[cRed!65!black, line width=0.42pt] (6.55, 3.63) -- (6.60, 3.60);  % SE
\draw[cRed!65!black, line width=0.42pt] (6.55, 3.63) -- (6.64, 3.60);  % ESE
% Surface charge "+" markers — iter 10: 4.5pt → 5.5pt (1.22×) for crisp
% glyph reading (iter 9 left them looking like tick marks). Color stays
% cRed!70!black. 5 markers evenly spaced on polymer front-top edge.
\foreach \cx in {6.40, 6.70, 7.05, 7.40, 7.70} {
  \node[font=\sffamily\bfseries\fontsize{5.5}{6.6}\selectfont,
        text=cRed!70!black, inner sep=0pt]
    at (\cx, 3.595) {$+$};
}
...
%
% Vertical shaft — iter 16: bottom y=3.66 → 3.77 (matches new disk top).
% Width 0.08cm + axis shading preserved.
\shade[left color=cGray!80!black, middle color=cGray!18,
       right color=cGray!80!black]
  (7.36, 3.77) rectangle (7.44, 3.95);
\draw[cGray!80!black, line width=0.18pt]
  (7.36, 3.77) -- (7.36, 3.95);
\draw[cGray!80!black, line width=0.18pt]
  (7.44, 3.77) -- (7.44, 3.95);
\fill[white, opacity=0.55] (7.395, 3.77) rectangle (7.405, 3.95);
% Disk electrode — iter 16: thickness 0.04 → 0.07cm (y=3.70..3.77).
% Shift up to clear thicker polymer (top y=3.60) + 0.10cm air gap.
\shade[left color=cAmber!28, middle color=cAmber!65,
       right color=cAmber!22]
  (7.20, 3.70) rectangle (7.60, 3.77);
\draw[cAmber!75!black, line width=0.45pt] (7.20, 3.70) rectangle (7.60, 3.77);
% Disk front-top edge specular — y=3.768..3.770 (matches new disk top).
\fill[white, opacity=0.55] (7.21, 3.768) rectangle (7.58, 3.770);
% Vertical vibration arrow — iter 17 (S6 fix): length 0.12 → 0.16cm
% (3.80..3.92 → 3.78..3.94). Arrow/shaft ratio 67% → 89%, matching literature
% convention where vibration cue spans most of shaft length.
\draw[<->, cGray!75!black, line width=0.40pt] (7.47, 3.78) -- (7.47, 3.94);
% Air gap indicator — iter 16: top y=3.62 → 3.70 (new disk bottom),
% bottom y=3.52 → 3.60 (new polymer top). Gap height 0.10cm preserved.
\draw[cGray!55!black, dashed, line width=0.18pt] (7.72, 3.70) -- (7.72, 3.60);
\draw[cGray!55!black, line width=0.22pt] (7.70, 3.70) -- (7.74, 3.70);
\draw[cGray!55!black, line width=0.22pt] (7.70, 3.60) -- (7.74, 3.60);
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!55!black,
      anchor=west] at (7.74, 3.65) {$d$};
% "Probe" label — iter 34: y nudged 4.00 → 4.05 for breathing room from
% oscillation arrow top (3.94) and bezier start (3.95).
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!75!black,
      anchor=south] at (7.40, 4.05) {Probe};
...
%
% (1) Front face — beige metal gradient
\shade[top color=cGray!4, bottom color=cGray!22]
  (8.20, 3.55) rectangle (9.05, 4.05);
\draw[cGray!60!black, line width=0.22pt]
  (8.20, 3.55) rectangle (9.05, 4.05);
% (2) Inset SCREEN frame — recessed darker display zone
\fill[cGray!18, rounded corners=0.4pt] (8.25, 3.83) rectangle (9.00, 4.00);
\draw[cGray!65!black, line width=0.18pt, rounded corners=0.4pt]
  (8.25, 3.83) rectangle (9.00, 4.00);
% (4a) y-axis arrow inside screen (V_s axis, vertical)
\draw[-{Stealth[length=2pt,width=1.6pt]}, cGray!75!black, line width=0.18pt]
  (8.30, 3.86) -- (8.30, 3.98);
% (4b) x-axis arrow inside screen (time axis, horizontal)
\draw[-{Stealth[length=2pt,width=1.6pt]}, cGray!75!black, line width=0.18pt]
  (8.30, 3.86) -- (8.92, 3.86);
% (4c) Decay curve — starts upper-left, exponential decay to lower-right
\draw[cGray!85!black, line width=0.35pt]
  (8.32, 3.97) .. controls (8.38, 3.94) and (8.45, 3.90) .. (8.55, 3.88)
              .. controls (8.65, 3.87) and (8.78, 3.86) .. (8.88, 3.865);
% (5) V_s meter label — iter 37: y 3.69→3.71 to compensate for subscript "s"
% baseline (Gemini "perceived vertical center skewed due to descender").
\node[font=\sffamily\bfseries\fontsize{6}{7.2}\selectfont, text=cGray!88!black]
  at (8.625, 3.71) {$V_s$ meter};
...
\draw[cGray!75!black, line width=0.22pt]
  (7.40, 3.95) .. controls (7.60, 3.95) and (8.00, 3.85) .. (8.20, 3.85);
% (7) Input port — small dark socket circle (cable entry on left wall)
\fill[cGray!85!black] (8.20, 3.85) circle (0.024);
\fill[cGray!50!black] (8.20, 3.85) circle (0.012);

% Polymer film identification label — iter 17 (S2 fix): repositioned LEFT
% of polymer band with leader line. Was BELOW substrate (target mismatch —
% label appeared to point at substrate). Now label at (6.15, 3.525) anchor=east
% pointing right via leader line to polymer band left edge (6.30, 3.525).
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!75!black,
      anchor=east] at (6.15, 3.525) {polymer film};
\draw[cGray!55!black, line width=0.18pt] (6.16, 3.525) -- (6.30, 3.525);
...
\node[labelMute, anchor=west, font=\sffamily\fontsize{6}{7.2}\selectfont,
      text=cGray!75!black, inner sep=1pt]
  at (7.05, 1.45) {derive};
...
\draw[cRed!55!black, line width=0.30pt] (12.48, 2.00) -- (12.75, 2.00);
...
\node[font=\sffamily\itshape\fontsize{5.5}{6.6}\selectfont, text=cRed!55!black,
      anchor=north] at (12.85, 1.78) {$F_{\mathrm{Maxwell}}$};
