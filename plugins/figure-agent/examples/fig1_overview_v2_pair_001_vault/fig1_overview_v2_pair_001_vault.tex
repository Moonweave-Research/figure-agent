...
%
% HV+ source — iter 17 (S1 fix): shifted up 0.05cm (4.05..4.20 → 4.10..4.25).
% Wire to needle cuff now 0.15cm (was 0.10cm) — reads as "remote source"
% via wire rather than "directly stacked on needle".
\shade[top color=cGray!2, bottom color=cGray!18]
  (6.35, 4.10) rectangle (6.75, 4.25);
\draw[cGray!55!black, line width=0.18pt]
  (6.35, 4.10) rectangle (6.75, 4.25);
\node[font=\sffamily\bfseries\fontsize{6}{7.2}\selectfont, text=cGray!88!black]
  at (6.55, 4.175) {HV+};
% Wire from HV box bottom to needle support ball — iter 17: length 0.10 → 0.15cm
\draw[cGray!75!black, line width=0.32pt] (6.55, 4.10) -- (6.55, 3.95);
...
% "Probe" label — iter 14d (P-E-008 forced fix): shifted further right to
% (7.51, 3.85). Reason: P-E-003 widened shaft to right edge 7.44; P-E-001
% placed vibration arrow at x=7.47. Probe label must clear both — x=7.51.
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!75!black,
      anchor=west] at (7.51, 3.85) {Probe};
...
\fill[cGray!18, rounded corners=0.4pt] (8.25, 3.83) rectangle (8.95, 4.00);
\draw[cGray!65!black, line width=0.18pt, rounded corners=0.4pt]
  (8.25, 3.83) rectangle (8.95, 4.00);
...
% (5) V_s meter label — BELOW screen, centered in box-bottom zone
\node[font=\sffamily\bfseries\fontsize{6}{7.2}\selectfont, text=cGray!88!black]
...
% PSU box (LEFT)
\draw[cGray!75!black, line width=0.30pt]
  (9.85, 3.75) rectangle (10.40, 4.25);
...
\node[font=\sffamily\fontsize{5.5}{6.6}\selectfont, text=cGray!75!black]
  at (10.125, 4.05) {$V_{\mathrm{active}}$};
...
\draw[cGray!75!black, line width=0.60pt]
  (9.92, 3.85) -- (10.02, 3.85) -- (10.02, 3.97)
              -- (10.15, 3.97) -- (10.15, 3.85) -- (10.35, 3.85);
...
% simplicity.
% Lead from PSU bottom to BOTTOM electrode top — iter 19: rerouted from
% (top-electrode-bottom) to (bottom-electrode-top). User direction: PSU
% drives the cantilever's electrode directly, inducing Maxwell stress at
% the bottom apparatus. Lead traverses inter-zone empty space at y=2.85
% then drops down to bottom electrode top edge (13.55, 2.60).
\draw[cGray!75!black, line width=0.28pt]
  (10.40, 3.85) -- (10.70, 3.85) -- (10.70, 2.85)
              -- (13.55, 2.85) -- (13.55, 2.60);
...
\shade[left color=cGray!75!black, right color=cGray!40!black]
  (13.55, 0.40) rectangle (13.80, 2.60);
\draw[cGray!85!black, line width=0.50pt]
  (13.55, 0.40) rectangle (13.80, 2.60);
\draw[white, opacity=0.50, line width=0.35pt]
  (13.555, 0.45) -- (13.555, 2.55);
\foreach \ey in {0.70, 1.10, 1.50, 1.90, 2.30} {
  \draw[cGray!75!black, line width=0.28pt]
    (13.80, \ey) -- (13.95, {\ey+0.08});
}
\draw[cGray!70!black, fill=cGray!50!black, line width=0.35pt]
  (13.57, 0.35) -- (13.78, 0.35) -- (13.675, 0.22) -- cycle;
\draw[cGray!70!black, line width=0.28pt] (13.61, 0.20) -- (13.74, 0.20);
\draw[cGray!70!black, line width=0.28pt] (13.64, 0.16) -- (13.71, 0.16);
...
\draw[-{Stealth[length=4pt,width=3pt]}, cRed!55!black, dashed,
      line width=0.45pt]
  (12.20, 1.80) -- (13.50, 1.80);
\node[font=\sffamily\itshape\fontsize{5.5}{6.6}\selectfont, text=cRed!55!black,
      anchor=north] at (12.85, 1.75) {$F_{\mathrm{Maxwell}}$ (baseline)};
