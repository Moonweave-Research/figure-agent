...
% Vibration cue — iter E11+E12+E15: TikZ \draw[<->] default Stealth tips
% at this small length (0.13cm) fused into "diamond/cross" pattern at print
% scale (user audit: "십자가/cross"). Replaced with unicode \updownarrow
% glyph at 7pt — proper typography character (sharp Y-shape arrowheads vs
% filled-triangle TikZ tips). Centered at shaft midpoint (7.32, 3.96).
\node[font=\fontsize{7}{8.4}\selectfont, text=cGray!75!black,
      inner sep=0pt] at (7.32, 3.96) {$\updownarrow$};
