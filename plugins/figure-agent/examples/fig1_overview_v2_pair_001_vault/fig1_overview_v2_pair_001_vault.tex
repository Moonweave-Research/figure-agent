...
\node[font=\sffamily\fontsize{6}{7.2}\selectfont, text=cGray!80!black,
      anchor=south, rotate=90] at (10.15, 6.30) {Energy};
...
% 3 spokes — Stealth, narrative weight promoted 0.9pt → 1.1pt + darker tone
% Cycle 1 / C403 (2026-05-22): pale 0.9pt cGray!65 spokes were dominated by
% A→B→C inter-arrow chain, so reader read Row 2 as D→E→F SEQUENTIAL. Promoting
% spoke stroke to top-of-3-tier (1.1pt, cGray!80) makes the fan visually
% dominant against the L→R inter-panel arrows.
\draw[-{Stealth[length=7pt,width=5pt]}, cGray!80!black, line width=1.1pt]
...
\path[draw=none] (0.65, 2.30) .. controls (0.95, 1.40) and (2.00, 0.50) .. (3.40, 0.45)
  node[pos=0.88, labelMute, text=cGray!65!black, sloped, above=6pt, inner sep=1pt]
  {Debye};
...
% Finding C001 (v1.9 re-audit, VC015): cGray!22 backdrop did not mask the
% wire stroke (still bisecting V glyph at zoom). Shifted label off the wire
% centerline x=6.55 → x=6.30 so the wire is outside the label bbox entirely.
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!75!black,
...
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!65!black,
      anchor=south] at (7.50, 4.10) {$V_s$ probe};
...
\node[labelMute, anchor=south, rotate=270,
      ...
      text=cGray!85!black] at (13.98, 1.50) {electrode};
