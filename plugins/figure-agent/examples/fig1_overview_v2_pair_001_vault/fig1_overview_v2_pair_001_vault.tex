...
\node[font=\sffamily\fontsize{6.5}{7.8}\itshape\selectfont, text=cGray!75!black,
...
\node[font=\sffamily\itshape\fontsize{6.5}{7.8}\selectfont, text=cGray!70!black,
...
\node[font=\sffamily\itshape\fontsize{6.5}{7.8}\selectfont, text=cGray!60!black,
...
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!65!black,
...
\foreach \tY in {7.55, 7.35} {
  \draw[cBlue!80!black, line width=1.10pt, line cap=round] (10.95, \tY) -- (11.55, \tY);
}
\foreach \tY in {6.20, 5.85} {
  \draw[cRed!80!black, line width=1.10pt, line cap=round] (10.95, \tY) -- (11.55, \tY);
}
...
\draw[{Stealth[length=2.6pt,width=2pt]}-{Stealth[length=2.6pt,width=2pt]},
      cRed!80!black, line width=0.45pt] (13.70, 8.27) -- (13.70, 5.83);
% Polish iter: 5.5 → 6.5pt + cRed!80!black (stronger visual binding to deep trap).
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cRed!80!black,
...
% Vertical dotted column dividers for parallel evidence separation
\draw[cGray!45!white, line width=0.35pt, densely dotted] (4.55, 0.20) -- (4.55, 4.30);
\draw[cGray!45!white, line width=0.35pt, densely dotted] (9.35, 0.20) -- (9.35, 4.30);
...
% iter 53: removed fill=cAmber!8 (Gemini Panel D MEDIUM). iter 53b: y +0.07cm
% to clear spoke arrows. iter E14 (user-flagged): without fill, the 0.9pt-
% thick spoke arrow lines visibly cross THROUGH label letters at high zoom.
% Restored fill with reduced opacity (cAmber!8 with fill opacity=0.85) —
% breaks arrow under label while letting background waves still flow.
\node[font=\sffamily\itshape\fontsize{6}{7.2}\selectfont, text=cGray!75!black,
      anchor=south, fill=cAmber!8, fill opacity=0.85, text opacity=1, inner sep=1pt]
...
% SMU box (LEFT, compact) — ICON QUALITY UPGRADE (ref: mim_smu_schematic_ref)
% AI reference shows: instrument body (gradient gray) + dark glass display window
% with amber stepped waveform + V/A label below display. Much more recognizable
% as a real SMU vs plain outline box.
% Body: subtle top color gradient for instrument depth cue.
\shade[top color=cGray!8, bottom color=cGray!28, rounded corners=1pt]
  (0.50, 3.15) rectangle (1.30, 3.70);
\draw[cGray!65!black, line width=0.28pt, rounded corners=1pt]
  (0.50, 3.15) rectangle (1.30, 3.70);
% Dark glass display window — oscilloscope aesthetic.
\fill[cGray!75!black, rounded corners=0.4pt] (0.57, 3.42) rectangle (1.23, 3.62);
\draw[cGray!88!black, line width=0.12pt, rounded corners=0.4pt]
  (0.57, 3.42) rectangle (1.23, 3.62);
% Amber stepped waveform inside display (DC-bias-on cue: step up → hold).
\draw[cAmber!90!white, line width=0.45pt]
  (0.61, 3.46) -- (0.71, 3.46) -- (0.71, 3.57)
              -- (0.97, 3.57) -- (0.97, 3.46) -- (1.19, 3.46);
% SMU and V/A labels stay inside the instrument body; external labels collide
% with the nearby I(t) plot annotation at manuscript scale. Keep V/A as a
% small secondary readout so it does not collide with the SMU name.
\node[font=\sffamily\itshape\fontsize{4.8}{5.8}\selectfont, text=cGray!68!black,
      anchor=center] at (0.90, 3.36) {SMU};
% V/A label below display — secondary label tier.
\node[font=\sffamily\fontsize{3.6}{4.3}\selectfont, text=cGray!68!black,
      anchor=center] at (0.90, 3.22) {V/A};
% Output terminal dot at right edge.
\fill[cGray!75!black] (1.30, 3.60) circle (0.020);
\fill[cGray!50!black] (1.30, 3.60) circle (0.010);
\fill[cGray!75!black] (1.30, 3.27) circle (0.020);
\fill[cGray!50!black] (1.30, 3.27) circle (0.010);

% MIM sample stack (CENTER, ENLARGED to be visual hero)
% ICON QUALITY UPGRADE: MIM electrodes upgraded to cross-hatch (+45° AND −45°)
% matching Conrad 2016 convention used in Column F. Cross-hatch reads as
% "polished metal" — far more distinctive than single-direction lines.
%
% Top electrode — cross-hatched (+45° and −45° lines).
\fill[cGray!30!white] (1.70, 3.70) rectangle (3.50, 3.80);
\draw[cGray!70!black, line width=0.30pt]
  (1.70, 3.70) rectangle (3.50, 3.80);
% +45° lines (left-lean)
\foreach \hx in {1.73, 1.85, 1.97, 2.09, 2.21, 2.33, 2.45, 2.57, 2.69, 2.81, 2.93, 3.05, 3.17, 3.29, 3.41} {
  \draw[cGray!55!black, line width=0.18pt] (\hx, 3.70) -- ({\hx+0.06}, 3.76);
}
% −45° lines (right-lean)
\foreach \hx in {1.73, 1.85, 1.97, 2.09, 2.21, 2.33, 2.45, 2.57, 2.69, 2.81, 2.93, 3.05, 3.17, 3.29, 3.41} {
  \draw[cGray!55!black, line width=0.18pt] (\hx, 3.76) -- ({\hx+0.06}, 3.70);
}
% Polymer film — gradient amber (top lighter, bottom deeper for depth).
\shade[top color=cAmber!28, bottom color=cAmber!48]
  (1.70, 3.25) rectangle (3.50, 3.70);
\draw[cAmber!70!black, line width=0.30pt]
  (1.70, 3.25) rectangle (3.50, 3.70);
% Thin top-edge sheen for film surface.
\fill[white, opacity=0.40] (1.71, 3.695) rectangle (3.49, 3.700);
% Bottom electrode — cross-hatched (same convention as top).
\fill[cGray!30!white] (1.70, 3.15) rectangle (3.50, 3.25);
\draw[cGray!70!black, line width=0.30pt]
  (1.70, 3.15) rectangle (3.50, 3.25);
% +45° lines
\foreach \hx in {1.73, 1.85, 1.97, 2.09, 2.21, 2.33, 2.45, 2.57, 2.69, 2.81, 2.93, 3.05, 3.17, 3.29, 3.41} {
  \draw[cGray!55!black, line width=0.18pt] (\hx, 3.15) -- ({\hx+0.06}, 3.21);
}
% −45° lines
\foreach \hx in {1.73, 1.85, 1.97, 2.09, 2.21, 2.33, 2.45, 2.57, 2.69, 2.81, 2.93, 3.05, 3.17, 3.29, 3.41} {
  \draw[cGray!55!black, line width=0.18pt] (\hx, 3.21) -- ({\hx+0.06}, 3.15);
}

% 2 leads from SMU terminal dots to MIM stack
...
% Contact dots at lead-electrode junctions.
...
\fill[cRed!85!black] (1.20, 2.00) circle (0.04);
\fill[cRed!85!black] (2.00, 1.56) circle (0.04);
\fill[cRed!85!black] (2.80, 1.12) circle (0.04);
\fill[cRed!85!black] (3.60, 0.69) circle (0.04);

\fill[cBlue!60!black] (1.20, 2.16) circle (0.035);
\fill[cBlue!60!black] (2.00, 1.96) circle (0.035);
\fill[cBlue!60!black] (2.80, 1.76) circle (0.035);
\fill[cBlue!60!black] (3.60, 1.56) circle (0.035);
...
\fill[cGray!70!black] (6.55, 4.12) circle (0.018);
\fill[cGray!40!black] (6.55, 4.12) circle (0.009);
...
% HV+ label — y 4.20 → 4.14. iter E2 plain weight. iter E14 (user-flagged):
% terminal → cuff wire at x=6.55, y=4.05..4.10 was crossing through label
% letters. fill=cGray!22 matching box body masks wire. iter E14b: reordered
% to draw AFTER wire (label was being drawn first → wire visible on top).
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!75!black,
      fill=cGray!22, inner sep=0.5pt]
  at (6.55, 4.14) {HV+};
...
\draw[cGray!90!black, line width=0.22pt]
  (6.535, 4.05) -- (6.565, 4.05) -- (6.55, 3.73) -- cycle;
% iter E13: cuff radius 0.045 → 0.025 + tone cGray!85 → !65 (was dominant
% black dot reading as "button"; now subtle support indicator).
\fill[cGray!65!black] (6.55, 4.05) circle (0.025);
...
% Vibration cue — ICON QUALITY UPGRADE (ref: ispd_apparatus_schematic_ref)
% AI reference shows 3 concentric arcs on BOTH sides of the disk — the
% standard "vibrating probe" motif used in KPFM/Kelvin probe literature.
% Replaced \updownarrow unicode glyph with real curved arc lines on LEFT side
% of disk (right side has HV+ box, no room). 3 arcs at increasing radii.
% Arc center = disk midpoint (7.40, 3.835). Arcs span 120°-160° sector left.
\draw[cGray!60!black, line width=0.20pt]
  (7.20, 3.835) arc[start angle=180, end angle=130, radius=0.20cm];
\draw[cGray!60!black, line width=0.20pt]
  (7.20, 3.835) arc[start angle=180, end angle=230, radius=0.20cm];
\draw[cGray!55!black, line width=0.18pt]
  (7.14, 3.835) arc[start angle=180, end angle=125, radius=0.26cm];
\draw[cGray!55!black, line width=0.18pt]
  (7.14, 3.835) arc[start angle=180, end angle=235, radius=0.26cm];
\draw[cGray!50!black, line width=0.16pt]
  (7.08, 3.835) arc[start angle=180, end angle=120, radius=0.32cm];
\draw[cGray!50!black, line width=0.16pt]
  (7.08, 3.835) arc[start angle=180, end angle=240, radius=0.32cm];
...
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!65!black,
      anchor=south] at (7.34, 4.10) {Probe};
...
\draw[-{Stealth[length=4pt,width=3pt]}, cGray!65!black, line width=0.40pt]
  (4.95, 1.65) -- (8.55, 1.65);
\draw[cGray!65!black, line width=0.40pt] (4.95, 2.05) -- (5.02, 2.05);
\draw[cGray!65!black, line width=0.40pt] (4.95, 2.45) -- (5.02, 2.45);
\draw[cGray!65!black, line width=0.40pt] (6.15, 1.65) -- (6.15, 1.72);
\draw[cGray!65!black, line width=0.40pt] (7.35, 1.65) -- (7.35, 1.72);
...
\draw[cGray!65!black, line width=0.40pt] (4.95, 0.75) -- (5.02, 0.75);
\draw[cGray!65!black, line width=0.40pt] (4.95, 1.10) -- (5.02, 1.10);
\draw[cGray!65!black, line width=0.40pt] (6.15, 0.40) -- (6.15, 0.47);
\draw[cGray!65!black, line width=0.40pt] (7.35, 0.40) -- (7.35, 0.47);
...
\fill[cBlue!85!black] (5.55, 0.65) circle (0.04);
\fill[cBlue!85!black] (5.70, 0.85) circle (0.04);
\fill[cBlue!85!black] (5.85, 0.65) circle (0.04);
\fill[cRed!85!black] (6.55, 0.80) circle (0.04);
\fill[cRed!85!black] (6.78, 1.15) circle (0.04);
\fill[cRed!85!black] (7.01, 0.80) circle (0.04);
...
\node[labelMute, anchor=north, text=cGray!70!black,
      font=\sffamily\fontsize{6.5}{7.8}\selectfont] at (5.70, 0.32) {Shallow};
\node[labelMute, anchor=north, text=cGray!70!black,
      font=\sffamily\fontsize{6.5}{7.8}\selectfont] at (6.78, 0.32) {Deep};
...
% F-4 result zone clip + mount — ICON QUALITY UPGRADE (ref: cantilever_mechanical_schematic_ref)
% AI reference: T-bracket profile = wide horizontal ceiling bar + narrow vertical stem
% + cross-hatch fill in bracket body. Reads as "rigid metal anchor" not a plain box.
%
% Ceiling bar (wide horizontal, cross-hatched)
\fill[cGray!40!white] (12.10, 2.60) rectangle (12.80, 2.72);
\draw[cGray!72!black, line width=0.35pt]
  (12.10, 2.60) rectangle (12.80, 2.72);
% Cross-hatch in ceiling bar (+45° and −45°)
\foreach \bx in {12.14, 12.22, 12.30, 12.38, 12.46, 12.54, 12.62, 12.70, 12.78} {
  \draw[cGray!52!black, line width=0.16pt] (\bx, 2.60) -- ({\bx+0.06}, 2.66);
  \draw[cGray!52!black, line width=0.16pt] (\bx, 2.66) -- ({\bx+0.06}, 2.60);
}
% Vertical stem of T-bracket (narrower, centered)
\fill[cGray!35!white] (12.35, 2.42) rectangle (12.55, 2.60);
\draw[cGray!70!black, line width=0.32pt]
  (12.35, 2.42) rectangle (12.55, 2.60);
% Cantilever attachment clamp box (at base of stem)
\fill[cGray!45!white] (12.28, 2.38) rectangle (12.62, 2.46);
\draw[cGray!72!black, line width=0.32pt]
  (12.28, 2.38) rectangle (12.62, 2.46);
...
% ICON QUALITY UPGRADE: cantilever amber gradient deeper (cAmber!32→cAmber!55)
% for more saturated polymer material identity.
\shade[top color=cAmber!30, bottom color=cAmber!55, rounded corners=0.3mm]
  (12.32, 2.38) .. controls (12.32, 1.85) and (12.05, 1.35) ..
  (11.75, 0.85) -- (11.90, 0.85) .. controls (12.20, 1.35) and
  (12.45, 1.85) .. (12.45, 2.38) -- cycle;
\draw[cAmber!80!black, line width=0.55pt, rounded corners=0.3mm]
  (12.32, 2.38) .. controls (12.32, 1.85) and (12.05, 1.35) ..
  (11.75, 0.85) -- (11.90, 0.85) .. controls (12.20, 1.35) and
  (12.45, 1.85) .. (12.45, 2.38) -- cycle;
% Subtle interior midlines for cantilever depth.
\draw[cAmber!65!black, line width=0.28pt, opacity=0.40]
  (12.255, 2.32) .. controls (12.255, 1.85) and (11.985, 1.35) .. (11.685, 0.88);
\draw[cAmber!65!black, line width=0.28pt, opacity=0.40]
  (12.385, 2.32) .. controls (12.385, 1.85) and (12.115, 1.35) .. (11.815, 0.88);
...
\draw[-{Stealth[length=4pt,width=3pt]}, cGray!55!black, dashed,
      line width=0.45pt]
