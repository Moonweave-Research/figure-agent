...
\fill[black, opacity=0.18, rounded corners=1.2pt] (5.86, 4.09) rectangle (6.51, 4.34);
\shade[top color=cGray!18, bottom color=cGray!50, rounded corners=1.2pt]
...
\fill[black, opacity=0.18, rounded corners=1.2pt] (7.71, 3.55) rectangle (8.71, 4.02);
\shade[top color=cGray!18, bottom color=cGray!50, rounded corners=1.2pt]
...
% Box: x=7.68..8.68, y=3.58..4.05. Display: x=7.72..8.56, y=3.78..4.00.
% Label sits at box bottom area (y=3.66, between box bottom 3.58 and display 3.78).
\node[font=\sffamily\fontsize{5.5}{6.6}\selectfont, text=cGray!55!black]
