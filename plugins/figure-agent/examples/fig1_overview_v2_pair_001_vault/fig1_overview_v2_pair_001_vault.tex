...
\draw[cGray!55!black, line width=0.20pt, rounded corners=0.4pt]
  (6.10, 4.10) rectangle (6.95, 4.40);
% iter 44: bg lightened cGray!85→!70 black (consistent with V_s meter display).
\fill[cGray!70!black, rounded corners=0.2pt] (6.20, 4.31) rectangle (6.85, 4.38);
\draw[cGray!85!black, line width=0.12pt, rounded corners=0.2pt]
  (6.20, 4.31) rectangle (6.85, 4.38);
\draw[cAmber!90!white, line width=0.45pt]
  (6.23, 4.335) -- (6.36, 4.335) -- (6.36, 4.375)
              -- (6.53, 4.375) -- (6.53, 4.335) -- (6.68, 4.335)
              -- (6.68, 4.375) -- (6.82, 4.375);
...
% Surface charges — iter 45 (Pri 5a + 10): white "+" 4pt→5pt (visible at print
% scale), leftmost charge 6.40→6.35 to clear spark WSW tip (was overlapping).
\foreach \cx in {6.35, 6.70, 7.05, 7.40, 7.70} {
...
% Vibration cue — iter 42 (E-2d-iii redesign, Gemini Top 1 fix): replaced
% Stealth path (was "disastrous hand-drawn squiggle" at small scale) with
% typographic $\updownarrow$ glyph — clean symmetric Unicode-style icon
% standard in publication apparatus diagrams.
\node[font=\fontsize{9}{10.8}\selectfont, text=cGray!75!black,
      inner sep=0pt] at (7.55, 3.91) {$\updownarrow$};
% Air gap d — iter 46 (Pri 9): T-caps equalized + shifted DOWN slightly so top
% cap no longer crashes into Kelvin disk bottom (3.80). Top cap moved 3.80→3.78.
\draw[cGray!55!black, dashed, line width=0.18pt] (7.72, 3.78) -- (7.72, 3.62);
\draw[cGray!55!black, line width=0.22pt] (7.69, 3.78) -- (7.75, 3.78);
\draw[cGray!55!black, line width=0.22pt] (7.69, 3.62) -- (7.75, 3.62);
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!55!black,
      anchor=west] at (7.75, 3.70) {$d$};
% "Probe" label — iter 43: removed \itshape (descriptive text, not math var)
% — Gemini Top 2 fix for inappropriate italicization.
\node[font=\sffamily\fontsize{5}{6}\selectfont, text=cGray!75!black,
      anchor=south] at (7.40, 4.00) {Probe};
...
\fill[cGray!70!black, rounded corners=0.3pt] (8.05, 3.83) rectangle (9.05, 4.00);
\draw[cGray!85!black, line width=0.15pt, rounded corners=0.3pt]
  (8.05, 3.83) rectangle (9.05, 4.00);
\draw[-{Stealth[length=1.5pt,width=1.2pt]}, cGray!30!white, line width=0.20pt]
  (8.10, 3.86) -- (8.10, 3.98);
\draw[-{Stealth[length=1.5pt,width=1.2pt]}, cGray!30!white, line width=0.20pt]
  (8.10, 3.86) -- (8.98, 3.86);
% Single smooth bezier (no mid-curve kink)
\draw[cAmber!90!white, line width=0.45pt]
  (8.12, 3.97) .. controls (8.35, 3.93) and (8.65, 3.87) .. (8.95, 3.86);
% (5) V_s meter label — iter 43 (Gemini Top 2): $\mathsf{V_s}$ sans-serif math
% to match "meter" sans-serif text — eliminates serif math + sans text font
% collision Gemini flagged as "jarring".
\node[font=\sffamily\bfseries\fontsize{6}{7.2}\selectfont, text=cGray!88!black]
  at (8.55, 3.69) {$\mathsf{V_s}$ meter};
...
% Cable + Input port — iter 45 (Pri 6b): port moved INSIDE meter body
% (x 8.00→8.04, was resting ON box left edge). Cable extends to new port.
\draw[cGray!75!black, line width=0.22pt]
  (7.40, 3.95) .. controls (7.55, 3.95) and (7.88, 3.85) .. (8.04, 3.85);
\fill[cGray!85!black] (8.04, 3.85) circle (0.024);
\fill[cGray!50!black] (8.04, 3.85) circle (0.012);

% Polymer film label — iter 43: \itshape removed (descriptive, not math var)
% — Gemini Top 2 typography unification.
\node[font=\sffamily\fontsize{5}{6}\selectfont, text=cGray!75!black,
      anchor=east] at (6.15, 3.525) {polymer film};
\draw[cGray!55!black, line width=0.18pt] (6.16, 3.525) -- (6.26, 3.525);
\fill[cGray!55!black] (6.26, 3.525) circle (0.012);
...
\foreach \mx/\my in {5.45/2.32, 5.95/1.96, 6.45/1.78, 7.10/1.65} {
...
% iter 47 (Top Defect 1): Gaussian borders cBlue!85!black → cBlue!85 (no black
% mix) + fill opacity 35→25 (Gemini "20-30% translucent DOS layered elegance").
