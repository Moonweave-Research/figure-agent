...
% Vibration cue — iter E11 (user-flagged): \updownarrow at (7.62, 3.91) was
% floating 0.18-0.26cm RIGHT of probe shaft — disconnected from oscillating
% element. Replaced with TikZ default `<->` double-arrow attached LEFT of
% shaft (x=7.32), y 3.84..4.00 (0.16cm tall — Stealth tips have breathing
% room, no longer overlap as filled-star artifact).
\draw[<->, cGray!75!black, line width=0.32pt]
  (7.32, 3.84) -- (7.32, 4.00);
% Air gap d — iter 49 (Codex): shifted right. iter E6: line weights bumped
% (0.18→0.22pt dashed, 0.22→0.28pt T-bars) + T-bar width 0.06→0.10cm for
% better print-scale legibility of air-gap dimension annotation.
\draw[cGray!55!black, dashed, line width=0.22pt] (7.80, 3.78) -- (7.80, 3.62);
\draw[cGray!55!black, line width=0.28pt] (7.75, 3.78) -- (7.85, 3.78);
\draw[cGray!55!black, line width=0.28pt] (7.75, 3.62) -- (7.85, 3.62);
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!55!black,
      anchor=west] at (7.85, 3.70) {$d$};
...
% iter E9: cable line width 0.22 → 0.30pt for clearer wire identification.
% Previous 0.22pt read as "axis tier"; 0.30pt = annotation tier, matches
% Panel D/F lead conventions (0.28-0.32pt) for cross-panel cable rhythm.
