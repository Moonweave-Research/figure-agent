...
\begin{tikzpicture}[
  ...
  panelLetter/.style={font=\sffamily\bfseries\fontsize{9}{10.8}\selectfont,
                      text=cGray!90!black},
]
...
% Row 2 column rules — Designer iter (2026-05-22): the NC redirect stripped
% the Row-2 wash + dotted dividers, which left D / E / F floating in a single
% unstructured band. Thin 0.20pt cGray!22 verticals reintroduce the column
% landmark without bringing back any colored fill (NC main-text Fig 1 still
% reads as 'white background'). Rules are drawn before panel content so they
% sit under any element that may cross them (axis arrowheads, leader strokes).
\draw[cGray!22, line width=0.20pt] (4.62, 0.20) -- (4.62, 4.40);
\draw[cGray!22, line width=0.20pt] (9.47, 0.20) -- (9.47, 4.40);
...
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!65!black,
      anchor=south] at (7.1, 4.1) {$V_s$ probe};
...
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!65!black,
      anchor=east] at (5.6, 3.5) {polymer film};
\draw[cGray!55!black, line width=0.18pt] (5.61, 3.5) -- (5.88, 3.525);
\fill[cGray!55!black] (5.88, 3.525) circle (0.012);
...
\fill[cBlue!85!black] (5.75, 0.65) circle (0.04);
\fill[cBlue!85!black] (5.9, 0.85) circle (0.04);
\fill[cBlue!85!black] (6.05, 0.65) circle (0.04);
\fill[cRed!85!black] (6.75, 0.8) circle (0.04);
\fill[cRed!85!black] (6.98, 1.15) circle (0.04);
\fill[cRed!85!black] (7.21, 0.8) circle (0.04);
