...
\fill[cRed!85!black] (6.41, 4.26) circle (0.018);
\fill[cRed!50, opacity=0.6] (6.41, 4.26) circle (0.030);
...
% Panel E iter 36 [round 6 focal, 2026-05-27]: HV+ label primary tier.
% Corona-charging is method focal — HV+ deserves primary label tier.
% Font 6→6.5pt + tone cGray!65 → cGray!80!black + slight bold tier.
...
\shade[left color=cGray!25, middle color=cGray!42,
       right color=cGray!22]
  (6.8, 3.8) rectangle (7.2, 3.87);
\draw[cGray!55!black, line width=0.28pt] (6.8, 3.8) rectangle (7.2, 3.87);
...
% iter 36 follow-up: V_s meter tertiary tier — 6pt → 5.5pt + cGray!55!black.
\node[font=\sffamily\fontsize{5.5}{6.6}\selectfont, text=cGray!55!black]
  at (8.14, 3.70) {$V_s$ meter};
