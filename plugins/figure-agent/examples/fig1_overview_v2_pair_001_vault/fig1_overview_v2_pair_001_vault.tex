...
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!55!black,
...
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!65!black,
      anchor=west] at (12.15, 8.10) {mobility edge};
...
\foreach \tY in {7.55, 7.35} {
  \draw[cBlue!80!black, line width=1.15pt, line cap=butt] (10.95, \tY) -- (11.55, \tY);
}
\foreach \tY in {6.20, 5.85} {
  \draw[cRed!80!black, line width=1.15pt, line cap=butt] (10.95, \tY) -- (11.55, \tY);
}
...
\node[font=\sffamily\bfseries\fontsize{6.5}{7.8}\selectfont,
      text=cBlue!75!black, anchor=west] at (12.85, 7.45) {shallow};
\node[font=\sffamily\bfseries\fontsize{6.5}{7.8}\selectfont,
...
\draw[{Stealth[length=3.2pt,width=2.4pt]}-{Stealth[length=3.2pt,width=2.4pt]},
      cRed!80!black, line width=0.50pt] (13.40, 8.27) -- (13.40, 5.83);
...
\shade[top color=cGray!4, bottom color=cGray!40, rounded corners=2pt]
  (0.50, 3.07) rectangle (1.30, 3.77);
\draw[cGray!75!black, line width=0.30pt, rounded corners=2pt]
  (0.50, 3.07) rectangle (1.30, 3.77);
...
\draw[cGray!75!black, line width=0.35pt, rounded corners=2pt]
...
% Panel E iter 16 [Panel E full-loop, 2026-05-27]: cool metallic cast.
% User: "올드함 못 지우겠지 색상이 문젠가". Mono-cGray gradient = '회색 페인트'
% feel, not anodized metal. Replaced cGray with cBlue (#4477AA, teal-blue
% cast): top cGray!12 -> cBlue!10, bottom cGray!58 -> cBlue!42. Stroke
% cGray!65!black -> cBlue!55!black. Drop shadow stays neutral black.
\fill[black, opacity=0.35, rounded corners=1.8pt] (5.74, 4.06) rectangle (6.59, 4.36);
\shade[top color=cBlue!10, bottom color=cBlue!42, rounded corners=1.8pt]
  (5.7, 4.1) rectangle (6.55, 4.4);
\draw[cBlue!55!black, line width=0.22pt, rounded corners=1.8pt]
  (5.7, 4.1) rectangle (6.55, 4.4);
% Display — iter 50: enlarged vertically 0.07→0.16cm (was squashed 9:1 flat
% per user "신호 찌그러짐"). New extent 4.22..4.38.
\fill[cGray!70!black, rounded corners=1pt] (5.8, 4.22) rectangle (6.45, 4.38);
\draw[cGray!85!black, line width=0.12pt, rounded corners=1pt]
...
% Panel E iter 11 [Panel E full-loop, 2026-05-27]: DC glyph + readout text.
% Panel E iter 17 [Panel E full-loop, 2026-05-27]: readout cAmber -> cool LCD.
% iter 11 amber (cAmber!90!white) = 80s CRT/calculator stereotype. Modern LCD
% on HV/measurement instrument: high-contrast white text with subtle cool
% tint. Replaced with cBlue!8!white = nearly white with blue cast.
\node[font=\ttfamily\bfseries\fontsize{5.5}{6.6}\selectfont, text=cBlue!8!white]
  at (6.125, 4.30) {5 kV};
...
% Panel E iter 14 [Panel E full-loop, 2026-05-27]: corona needle re-detail.
% Triangular needle widened slightly (base 0.030 -> 0.040) for stronger
% material identity at print. Gradient tone narrower (!75 → !80, !90 → !95)
% for sharper metallic shading. Tip stroke weight 0.22 -> 0.25pt for crisp
% silhouette. Cuff ball-shaded for 3D feel (was flat fill).
\shade[left color=cGray!80!black, right color=cGray!95!black]
  (6.13, 4.05) -- (6.17, 4.05) -- (6.15, 3.73) -- cycle;
\draw[cGray!95!black, line width=0.25pt]
  (6.13, 4.05) -- (6.17, 4.05) -- (6.15, 3.73) -- cycle;
% iter E13: cuff radius 0.045 → 0.025 + tone cGray!85 → !65 (was dominant
% black dot reading as "button"; now subtle support indicator).
% iter14: flat fill -> ball-shaded sphere for 3D cuff bushing identity.
\shade[ball color=cGray!70!black] (6.15, 4.05) circle (0.028);
...
\fill[cBlue!28, opacity=0.55] (6.15, 3.73) -- (5.95, 3.6) -- (6.55, 3.6) -- cycle;
\draw[cBlue!65, line width=0.35pt, opacity=0.65] (6.15, 3.73) -- (6.15, 3.6);
...
% Panel E iter 13 [Panel E full-loop, 2026-05-27]: V_s probe shaft modernize.
% Shaft width 0.08cm -> 0.10cm + cuff bullet (top dot for cable connection
% point per modern ESVM probe design — cable attaches at shaft top dome).
% Width: (6.95, 4.05) ↔ (7.05, 4.05). Center spec highlight x 6.995→7.005.
\shade[left color=cGray!80!black, middle color=cGray!18,
       right color=cGray!80!black]
  (6.95, 3.87) rectangle (7.05, 4.05);
\draw[cGray!80!black, line width=0.20pt]
  (6.95, 3.87) -- (6.95, 4.05);
\draw[cGray!80!black, line width=0.20pt]
  (7.05, 3.87) -- (7.05, 4.05);
\fill[white, opacity=0.55] (6.995, 3.87) rectangle (7.005, 4.05);
% Cable connection dome at shaft top (3D dot for cable attachment point)
\shade[ball color=cGray!75!black] (7.00, 4.06) circle (0.025);
...
\fill[black, opacity=0.35, rounded corners=1.8pt] (7.72, 3.54) rectangle (8.72, 4.01);
\shade[top color=cBlue!10, bottom color=cBlue!42, rounded corners=1.8pt]
...
\fill[cGray!70!black, rounded corners=1pt] (7.72, 3.78) rectangle (8.56, 4);
...
% iter17 follow-up: V_s meter readout matching LCD style.
\node[font=\ttfamily\bfseries\fontsize{5.5}{6.6}\selectfont, text=cBlue!8!white]
  at (8.14, 3.89) {0.32\,V};
...
\draw[cGray!75!black, line width=0.35pt]
  (7.00, 4.085) .. controls (7.15, 4.07) and (7.52, 3.9) .. (7.72, 3.85);
\shade[ball color=cGray!85!black] (7.72, 3.85) circle (0.028);
...
% Panel E iter 4 [Panel E full-loop, 2026-05-27]: polymer leader endpoint shift.
% Old endpoint (5.88, 3.55) sat ON polymer top edge but within corona-cone
% region (cone span x=5.95..6.55) — close to ⊕ marker zone start (x=6.25
% leftmost). Reader could mis-read leader as pointing at first ⊕ charge.
% Moved leader dot to (5.95, 3.52) — slightly inside polymer slab (top y=3.60,
% interior y=3.52), at slab LEFT corner (slab x range 5.9..7.45). Leader now
% terminates ON polymer body, clear of cone+⊕ zone.
\node[font=\sffamily\itshape\fontsize{6.5}{7.8}\selectfont,
      text=cGray!65!black, anchor=west] at (4.72, 3.5) {polymer};
\draw[cGray!55!black, line width=0.18pt] (5.45, 3.5) -- (5.95, 3.52);
\fill[cGray!55!black] (5.95, 3.52) circle (0.012);
