...
% D-2 apparatus zone: current-source ⊙ + 2 leads + thin-film slab
% Centered around (2.28, 3.55). Mono cGray!75!black 0.30pt per §3.2.
\fill[cAmber!20] (1.83, 3.30) rectangle (2.73, 3.42);
\draw[cGray!75!black, line width=0.30pt]
  (1.83, 3.30) rectangle (2.73, 3.42);
% Current source circle + internal arrow
\draw[cGray!75!black, line width=0.30pt] (2.28, 3.85) circle (0.13);
\draw[-{Stealth[length=2pt,width=1.5pt]}, cGray!75!black, line width=0.20pt]
  (2.28, 3.93) -- (2.28, 3.77);
% 2 leads from source to slab (T-junctions)
\draw[cGray!75!black, line width=0.25pt] (2.05, 3.85) -- (2.05, 3.42);
\draw[cGray!75!black, line width=0.25pt] (2.51, 3.85) -- (2.51, 3.42);
\draw[cGray!75!black, line width=0.25pt] (2.05, 3.85) -- (2.15, 3.85);
\draw[cGray!75!black, line width=0.25pt] (2.41, 3.85) -- (2.51, 3.85);
...
% E-2 apparatus zone: corona ▽ + Kelvin probe ▭ + thin-film slab
% Centered around (6.975, 3.55).
\fill[cAmber!20] (6.55, 3.40) rectangle (7.40, 3.50);
\draw[cGray!75!black, line width=0.30pt]
  (6.55, 3.40) rectangle (7.40, 3.50);
% Corona needle (downward triangle apex pointing to slab top)
\draw[cGray!75!black, line width=0.30pt]
  (6.65, 3.85) -- (6.85, 3.85) -- (6.75, 3.65) -- cycle;
% Kelvin probe (small rectangle hovering above slab right half)
\draw[cGray!75!black, line width=0.30pt]
  (7.05, 3.65) rectangle (7.28, 3.75);
% Probe support stem
\draw[cGray!75!black, line width=0.22pt]
  (7.165, 3.75) -- (7.165, 3.88);
...
\draw[cAmber!70!black, line width=0.32pt, opacity=0.6]
  (12.40, 4.10) rectangle (12.50, 2.90);
% Neutral electrode (smaller than result-zone electrode)
\fill[cGray!50!white] (13.30, 2.90) rectangle (13.50, 4.05);
\draw[cGray!75!black, line width=0.30pt]
