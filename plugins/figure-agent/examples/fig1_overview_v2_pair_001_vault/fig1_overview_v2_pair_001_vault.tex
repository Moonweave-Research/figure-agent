...
% Iter 17 (2026-05-23): label was anchor=east at (5.60, 3.50) so the
% rendered text extended from TikZ x≈4.12 to 5.35 — crossing the D/E
% column rule (x=4.62) by 0.50 cm into Panel D's airspace. Flipped to
% anchor=west at (4.72, 3.50) so the label stays inside Panel E box left
% margin with 0.10 cm clearance from the column rule. Leader updated to
% point from the new label east edge (5.95) over to the slab top-left
% corner (5.90, 3.55) — short SW-ward leader pointing at the slab.
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!65!black,
      anchor=west] at (4.72, 3.5) {polymer film};
\draw[cGray!55!black, line width=0.18pt] (5.95, 3.5) -- (5.90, 3.55);
\fill[cGray!55!black] (5.90, 3.55) circle (0.012);
