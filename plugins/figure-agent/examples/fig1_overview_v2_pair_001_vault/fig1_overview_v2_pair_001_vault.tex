...
% 2-line stacked at italic 5.5pt fits the available gap between (S)_x
% top (y=7.85) and S₈ bottom (y=8.10) without restructuring S₈ position.
\node[font=\sffamily\fontsize{5}{5.7}\itshape\selectfont, text=cGray!75!black,
      anchor=center, fill=white, inner sep=1pt, align=center]
  at (2.50, 8.00) {inverse\\vulcanization};
...
%
% Polymer film (TOP, thin) — the layer under measurement
\fill[cAmber!28] (6.30, 3.45) rectangle (7.85, 3.52);
\draw[cAmber!70!black, line width=0.30pt]
  (6.30, 3.45) rectangle (7.85, 3.52);
% Substrate (BOTTOM, thick) — conductive base for ISPD charge-decay path.
% Iter 7: bottom edge 3.34 → 3.23 (substrate height 0.11 → 0.22cm).
% Iter 8: fill cGray!18 → cGray!28 + outline 0.30→0.35pt for material weight
% (ref01 substrate visually dominant + material identity per Tech illustrator).
\fill[cGray!28] (6.30, 3.23) rectangle (7.85, 3.45);
\draw[cGray!75!black, line width=0.35pt]
  (6.30, 3.23) rectangle (7.85, 3.45);
% Substrate diagonal hatching (10 lines, extended length for thicker substrate)
\foreach \hx in {6.40, 6.55, 6.70, 6.85, 7.00, 7.15, 7.30, 7.45, 7.60, 7.75} {
  \draw[cGray!55!black, line width=0.14pt] (\hx, 3.45) -- ({\hx-0.14}, 3.23);
}
...
\draw[cGray!75!black, line width=0.28pt] (7.85, 3.34) -- (7.95, 3.34) -- (7.95, 3.18);
\draw[cGray!75!black, line width=0.32pt] (7.88, 3.18) -- (8.02, 3.18);
\draw[cGray!75!black, line width=0.28pt] (7.90, 3.15) -- (8.00, 3.15);
\draw[cGray!75!black, line width=0.25pt] (7.92, 3.12) -- (7.98, 3.12);
...
%
% HV+ source box (component encapsulation)
\draw[cGray!75!black, line width=0.32pt] (6.35, 4.05) rectangle (6.75, 4.20);
\fill[white] (6.36, 4.06) rectangle (6.74, 4.19);
\node[font=\sffamily\bfseries\fontsize{5}{6}\selectfont, text=cGray!85!black]
  at (6.55, 4.125) {HV+};
% Wire from HV box bottom to needle support ball
\draw[cGray!75!black, line width=0.32pt] (6.55, 4.05) -- (6.55, 3.95);
% Vertical electrode stem with sharp triangular tip + discharge spark cue
\draw[cGray!85!black, line width=0.55pt] (6.55, 3.95) -- (6.55, 3.62);
\fill[cGray!85!black] (6.55, 3.95) circle (0.04);  % support ball at top
% Sharp filled triangular tip (downward point) — "needle electrode"
\fill[cGray!85!black] (6.50, 3.62) -- (6.55, 3.55) -- (6.60, 3.62) -- cycle;
% 3 short spark/discharge indicators radiating from tip toward sample
\draw[cRed!55!black, line width=0.30pt] (6.55, 3.53) -- (6.49, 3.47);  % SW
\draw[cRed!55!black, line width=0.30pt] (6.55, 3.53) -- (6.55, 3.45);  % S
\draw[cRed!55!black, line width=0.30pt] (6.55, 3.53) -- (6.61, 3.47);  % SE
% Iter 8: surface charge "+" markers on polymer top — ISPD essence (corona
% discharge deposits ions on polymer surface, which then decay over time).
% Per Tech illustrator audit "ISPD's whole point is surface-trapped charge".
\foreach \cx in {6.40, 6.70, 7.05, 7.40, 7.70} {
  \node[font=\sffamily\bfseries\fontsize{4}{4.8}\selectfont,
        text=cRed!60!black, inner sep=0pt]
    at (\cx, 3.495) {$+$};
}
...
%
% Vertical shaft (support to upper instrument lead — y=3.66 disk top to y=3.95 lead)
\draw[cGray!75!black, line width=0.32pt] (7.40, 3.95) -- (7.40, 3.66);
% Disk electrode at shaft bottom — flat horizontal conductive face.
% Iter 7: fill cGray!50!white → cAmber!18 (subtle metallic tint suggesting
% conductive Au/Pt electrode rather than generic gray); outline 0.32→0.40pt
% (slightly bolder for material identity per ref01 metallic instrument conv).
\fill[cAmber!18] (7.25, 3.62) rectangle (7.55, 3.66);
\draw[cGray!85!black, line width=0.40pt] (7.25, 3.62) rectangle (7.55, 3.66);
% Vertical vibration arrow ON shaft — Kelvin-probe modulation signature
% (vertical oscillation along shaft axis is the defining FM-CPD feature)
% Iter 8: arrow length 0.12→0.18cm (3.76..3.88 → 3.72..3.90) + weight
% 0.32→0.45pt for clearer signature presence per Tech illustrator audit.
\draw[<->, cGray!75!black, line width=0.45pt] (7.40, 3.72) -- (7.40, 3.90);
% Air gap indicator (vertical dashed line + d label) between disk bottom
% (y=3.62) and polymer film top (y=3.52). Gap d communicates non-contact
% measurement geometry (~100-500 μm in real systems).
\draw[cGray!55!black, dashed, line width=0.18pt] (7.68, 3.62) -- (7.68, 3.52);
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!55!black,
      anchor=west] at (7.70, 3.57) {$d$};
% "Probe" label — positioned to right of vibration arrow area
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!75!black,
      anchor=west] at (7.62, 3.82) {Probe};

% ----- V_s meter box (FAR-RIGHT, electrostatic meter) — display cue added -----
% Slightly larger meter box for waveform display
\draw[cGray!75!black, line width=0.30pt]
  (8.20, 3.65) rectangle (9.00, 4.05);
% V_s decay icon inside meter — iter 6 replacement of prior sinusoid
% (Tech illustrator audit: sine cue was WRONG — V_s is slow exponential
% decay over seconds, not AC signal). Exponential-decay curve communicates
% "this instrument reads slow potential decay" semantically correct.
\draw[cGray!60!black, line width=0.28pt]
  (8.30, 3.98) .. controls (8.38, 3.95) and (8.50, 3.93) .. (8.60, 3.92)
              .. controls (8.70, 3.92) and (8.80, 3.92) .. (8.88, 3.92);
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!75!black]
  at (8.60, 3.74) {$V_s$ meter};
% Lead from probe support to meter box LEFT side — iter 6: y updated to
% match new shaft top (3.85 → 3.95)
\draw[cGray!75!black, line width=0.22pt]
  (7.40, 3.95) -- (8.20, 3.95);

% Polymer film identification label — below substrate (post-iter7 fix:
% substrate bottom y=3.23 (was 3.34), label moved from y=3.32→3.20 to stay
% below thicker substrate. Ground bars now at y=3.12..3.18 (x=7.88..8.02)
% do not horizontally overlap with label at x=6.73..7.43.
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!75!black,
      anchor=north] at (7.075, 3.20) {polymer film};
...
\foreach \mx/\my in {5.45/2.32, 5.95/1.96, 6.45/1.78, 7.00/1.65, 7.55/1.65} {
...
\draw[-{Stealth[length=5pt,width=4pt]}, cGray!75!black, line width=0.55pt]
  (6.95, 1.55) -- (6.95, 1.28);
...
\draw[cBlue!85!black, fill=cBlue!35, line width=0.70pt]
  (5.30, 0.40) .. controls (5.55, 0.40) and (5.55, 0.85) .. (5.70, 0.85)
              .. controls (5.85, 0.85) and (5.85, 0.40) .. (6.10, 0.40);
\draw[cRed!85!black, fill=cRed!35, line width=0.70pt]
  (6.20, 0.40) .. controls (6.40, 0.40) and (6.40, 1.24) .. (6.80, 1.24)
              .. controls (7.20, 1.24) and (7.20, 0.40) .. (7.40, 0.40);
...
\draw[cRed!55!black, line width=0.32pt] (5.70, 1.42) -- (6.80, 1.42);
\draw[cRed!55!black, line width=0.32pt] (5.70, 1.39) -- (5.70, 1.45);  % left T-cap
\draw[cRed!55!black, line width=0.32pt] (6.80, 1.39) -- (6.80, 1.45);  % right T-cap
\node[labelMute, anchor=south, text=cRed!55!black,
      font=\sffamily\fontsize{6}{7.2}\selectfont, fill=cAmber!8, inner sep=1pt]
  at (6.25, 1.43) {$\tau_d$};
