...
% iter E16 (zoom-audit D1, 2026-05-21): 3 continuous waves broken into 3
% segments each at column dividers x=4.55 and x=9.35. At print scale the
% waves were faint cover-binding cue; at high zoom they were visibly
% crossing g(E_t) Gaussian outlines (wave 1) and V_s decay curve (wave 2),
% breaking data shape outlines. C006 resolution called for either dividers
% OR wave breaks — dividers shipped earlier, wave breaks land here. Each
% segment leaves a ~0.20cm gap centered on the divider so the dotted lines
% read as the active separation cue.
% Wave 1 (y≈1.20):
\draw[cAmber!10, line width=0.30pt] plot[smooth] coordinates
  {(0.10, 1.20) (2.50, 1.05) (4.45, 1.26)};
\draw[cAmber!10, line width=0.30pt] plot[smooth] coordinates
  {(4.65, 1.27) (5.00, 1.30) (7.50, 1.10) (9.25, 1.21)};
\draw[cAmber!10, line width=0.30pt] plot[smooth] coordinates
  {(9.45, 1.23) (10.00, 1.25) (12.50, 1.05) (13.90, 1.20)};
% Wave 2 (y≈2.50):
\draw[cAmber!10, line width=0.30pt] plot[smooth] coordinates
  {(0.10, 2.50) (2.50, 2.65) (4.45, 2.51)};
\draw[cAmber!10, line width=0.30pt] plot[smooth] coordinates
  {(4.65, 2.49) (5.00, 2.45) (7.50, 2.60) (9.25, 2.45)};
\draw[cAmber!10, line width=0.30pt] plot[smooth] coordinates
  {(9.45, 2.43) (10.00, 2.40) (12.50, 2.60) (13.90, 2.50)};
% Wave 3 (y≈3.80):
\draw[cAmber!10, line width=0.30pt] plot[smooth] coordinates
  {(0.10, 3.80) (2.50, 3.65) (4.45, 3.81)};
\draw[cAmber!10, line width=0.30pt] plot[smooth] coordinates
  {(4.65, 3.83) (5.00, 3.85) (7.50, 3.70) (9.25, 3.78)};
\draw[cAmber!10, line width=0.30pt] plot[smooth] coordinates
  {(9.45, 3.79) (10.00, 3.80) (12.50, 3.65) (13.90, 3.75)};
...
\draw[cAmber!90!white, line width=0.35pt] (6.28, 4.34) -- (6.78, 4.34);
\draw[cAmber!90!white, line width=0.35pt] (6.40, 4.28) -- (6.66, 4.28);
...
\fill[cRed!22, opacity=0.55] (6.55, 3.73) -- (6.35, 3.60) -- (6.95, 3.60) -- cycle;
...
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!65!black,
      anchor=south] at (7.34, 4.10) {$V_s$ probe};
