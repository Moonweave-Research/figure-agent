...
% Substrate (BOTTOM, thicker) — conductive base for ISPD charge-decay path
\fill[cGray!18] (6.30, 3.34) rectangle (7.85, 3.45);
\draw[cGray!75!black, line width=0.30pt]
  (6.30, 3.34) rectangle (7.85, 3.45);
% Substrate diagonal hatching (sparse — material identification cue)
\foreach \hx in {6.40, 6.55, 6.70, 6.85, 7.00, 7.15, 7.30, 7.45, 7.60, 7.75} {
  \draw[cGray!55!black, line width=0.14pt] (\hx, 3.45) -- ({\hx-0.07}, 3.34);
}
% Sample ground attaches to substrate (right edge, mid-substrate y)
\draw[cGray!75!black, line width=0.28pt] (7.85, 3.39) -- (7.95, 3.39) -- (7.95, 3.26);
\draw[cGray!75!black, line width=0.32pt] (7.88, 3.26) -- (8.02, 3.26);
\draw[cGray!75!black, line width=0.28pt] (7.90, 3.23) -- (8.00, 3.23);
\draw[cGray!75!black, line width=0.25pt] (7.92, 3.20) -- (7.98, 3.20);
...
% slightly wider than shaft for disk identity
\fill[cGray!50!white] (7.25, 3.62) rectangle (7.55, 3.66);
\draw[cGray!75!black, line width=0.32pt] (7.25, 3.62) rectangle (7.55, 3.66);
...
% Polymer film identification label — below substrate (post-iter2 fix:
% initial repositioning to above polymer collided with corona/probe area;
% reverted to below-substrate pattern). Ground at y=3.20..3.26 (x=7.85..)
% does not horizontally overlap with label at x=7.075.
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!75!black,
      anchor=north] at (7.075, 3.32) {polymer film};
