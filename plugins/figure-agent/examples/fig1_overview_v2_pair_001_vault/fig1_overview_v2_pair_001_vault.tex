...
% A-5 v8.6 [briefing relax R2, 2026-05-26]: v8.5 calibration — shadow
% opacity 0.40→0.28, specular opacity 0.65→0.45, radius 1.5mm→0.7mm
% (smaller + softer so it reads as light reflection, not floating disc).
% gradient delta preserved (mechanism-bound material identity cue).
\node[regular polygon, regular polygon sides=8, fill=black, opacity=0.28,
...
\fill[white, opacity=0.45]
  ([xshift=-1.2mm, yshift=1.2mm]s8.center) circle (0.7mm);
...
\fill[white, opacity=0.45] (7.85, 7.50) ellipse (1.5mm and 0.5mm);
% Right-edge thin shadow accent calibrated — 0.75→0.55
\draw[cAmber!85!black, line width=0.45pt, opacity=0.55]
  (9.85, 6.22) -- (9.85, 7.68);
% v8.6: bottom-edge ambient occlusion calibrated — 0.55→0.40
\draw[cAmber!90!black, line width=0.40pt, opacity=0.40]
  (7.60, 6.26) -- (9.80, 6.26);
...
\fill[black, opacity=0.25] (0.53, 3.04) rectangle (1.33, 3.74);
...
\draw[cGray!75!black, line width=0.30pt, rounded corners=1pt]
  (0.50, 3.07) rectangle (1.30, 3.77);
\fill[white, opacity=0.42] (0.61, 3.71) circle (0.6mm);
\node[font=\sffamily\itshape\fontsize{6}{7.2}\selectfont, text=cGray!75!black,
...
\fill[black, opacity=0.25] (5.72, 4.07) rectangle (6.57, 4.37);
...
\fill[black, opacity=0.25] (7.70, 3.55) rectangle (8.70, 4.02);
\shade[top color=cGray!4, bottom color=cGray!40, rounded corners=0.4pt]
...
\fill[black, opacity=0.28] (11.88, 2.39) rectangle (12.28, 2.49);
...
\draw[cGray!75!black, line width=0.40pt]
  (11.85, 2.42) rectangle (12.25, 2.52);
\draw[white, opacity=0.55, line width=0.35pt] (11.87, 2.515) -- (12.23, 2.515);
...
\fill[white, opacity=0.42] (11.965, 2.30) circle (0.6mm);
...
\fill[black, opacity=0.32] (13.27, 0.36) rectangle (13.44, 2.56);
...
\draw[cGray!85!black, line width=0.50pt]
  (13.23, 0.4) rectangle (13.4, 2.6);
\draw[white, opacity=0.70, line width=0.45pt]
  (13.235, 0.45) -- (13.235, 2.55);
\fill[white, opacity=0.50] (13.255, 2.53) circle (0.7mm);
