...
% ----- Kelvin probe (RIGHT, V_s readout) — enlarged + vibration cue -----
% Probe head: 0.40×0.13cm (was 0.30×0.10), better visibility at print
\fill[cGray!35!white] (7.20, 3.60) rectangle (7.60, 3.73);
\draw[cGray!75!black, line width=0.32pt]
  (7.20, 3.60) rectangle (7.60, 3.73);
% Probe support stem
\draw[cGray!75!black, line width=0.22pt]
  (7.40, 3.73) -- (7.40, 3.85);
% Vibration indicator: 2 short arcs above probe — Kelvin-probe modulation
% signature (frequency-mod measurement). Curves above probe top edge.
\draw[cGray!65!black, line width=0.25pt]
  (7.26, 3.78) .. controls (7.32, 3.81) and (7.48, 3.81) .. (7.54, 3.78);
\draw[cGray!65!black, line width=0.20pt]
  (7.29, 3.80) .. controls (7.33, 3.82) and (7.47, 3.82) .. (7.51, 3.80);
% "Probe" label
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!75!black,
      anchor=west] at (7.62, 3.67) {Probe};
...
% Small sinusoidal waveform inside upper meter — measurement-display cue
% (subtle, ~3 cycles, indicates "time-varying signal readout")
\draw[cGray!60!black, line width=0.22pt]
  (8.27, 3.93) .. controls (8.30, 3.97) and (8.34, 3.97) .. (8.37, 3.93)
              .. controls (8.40, 3.89) and (8.44, 3.89) .. (8.47, 3.93)
              .. controls (8.50, 3.97) and (8.54, 3.97) .. (8.57, 3.93)
              .. controls (8.60, 3.89) and (8.64, 3.89) .. (8.67, 3.93);
\node[font=\sffamily\itshape\fontsize{5}{6}\selectfont, text=cGray!75!black]
