...
\shade[top color=cGray!10, bottom color=cGray!22, rounded corners=1pt]
...
\shade[top color=cGray!10, bottom color=cGray!22, rounded corners=0.4pt]
...
% Iter 19 (2026-05-23): polymer film label REMOVED from Panel E entirely.
% Sequence of attempts: (iter 17) left-margin with leader → text crossed
% D/E column rule; (iter 18) inside slab → ⊕ surface charges competed for
% the 0.15 cm slab vertical space; (iter 19a) below substrate as Panel-C
% style caption → spatially disconnected from slab, looked like a V_s(t)
% plot subtitle instead. Self-identifying material wins: cAmber gradient
% slab + gray substrate stack + 4 surface ⊕ charges already reads as
% 'polymer film on conductor' per figure-wide cAmber=polymer convention
% (Panel A chain bond, Panel C film, Panel D MIM polymer film, Panel F
% cantilever all use the same cAmber identity). No label needed in this
% iconic-cartoon register.
...
\fill[cGray!50!white] (11.85, 2.42) rectangle (12.25, 2.52);
