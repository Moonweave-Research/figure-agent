...
% Designer iter 5 (2026-05-22): reference lines + axis labels pulled in from
% (10.55..13.80) + label x=13.95 to (10.55..11.55) + label x=11.60. The old
% 3.25 cm long horizontal references made Panel C's right edge extend to
% x≈15.10 (mobility edge label tail), 1.15 cm past the Row 2 box right edge —
% Row 2 visually 'indented' from Row 1. Now references end just before the
% trap-line / shallow-deep label cluster and labels sit next to the bands,
% matching standard NC energy-diagram convention.
\draw[cGray!45!black, densely dashed, line width=0.30pt] (10.55, 8.55) -- (11.55, 8.55);
\node[font=\sffamily\itshape\fontsize{6.5}{7.8}\selectfont, text=cGray!60!black,
      anchor=west] at (11.60, 8.55) {vacuum};
\draw[cGray!60!black, line width=0.45pt] (10.55, 8.30) -- (11.55, 8.30);
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!75!black,
      anchor=west] at (11.60, 8.30) {$E_C$};
\draw[cGray!55!black, dashed, line width=0.35pt] (10.55, 7.85) -- (11.55, 7.85);
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!65!black,
      anchor=west] at (11.60, 7.85) {mobility edge};
\draw[cGray!60!black, line width=0.45pt] (10.55, 5.30) -- (11.55, 5.30);
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!75!black,
      anchor=west] at (11.60, 5.30) {$E_V$};
...
\draw[{Stealth[length=2.6pt,width=2pt]}-{Stealth[length=2.6pt,width=2pt]},
      cRed!80!black, line width=0.45pt] (12.30, 8.27) -- (12.30, 5.83);
...
\draw[cGray!30, line width=0.35pt, rounded corners=2pt]
  (0.05, 0.10) rectangle (13.30, 4.50);
...
% (PSU shifted right). Path: (12.25, 3.5) → (12.83, 3.5) → (12.83, 2.6).
\draw[cGray!75!black, line width=0.28pt]
  (12.25, 3.5) -- (12.83, 3.5) -- (12.83, 2.6);
...
\fill[cGray!50!white] (11.45, 2.42) rectangle (11.85, 2.52);
\draw[cGray!75!black, line width=0.40pt]
  (11.45, 2.42) rectangle (11.85, 2.52);
\draw[cGray!50!black, line width=0.40pt] (11.35, 2.65) -- (11.95, 2.65);
\foreach \dx in {0,0.10,0.20,0.30,0.40,0.50} {
  \draw[cGray!50!black, line width=0.25pt]
    ({11.35+\dx}, 2.65) -- ({11.30+\dx}, 2.72);
}
\draw[cGray!75!black, line width=0.40pt] (11.65, 2.52) -- (11.65, 2.65);
...
\shade[top color=cAmber!22, bottom color=cAmber!42, rounded corners=0.3mm]
  (11.52, 2.42) .. controls (11.52, 1.85) and (11.25, 1.35) ..
  (10.95, 0.85) -- (11.1, 0.85) .. controls (11.4, 1.35) and
  (11.65, 1.85) .. (11.65, 2.42) -- cycle;
\draw[cAmber!80!black, line width=0.55pt, rounded corners=0.3mm]
  (11.52, 2.42) .. controls (11.52, 1.85) and (11.25, 1.35) ..
  (10.95, 0.85) -- (11.1, 0.85) .. controls (11.4, 1.35) and
  (11.65, 1.85) .. (11.65, 2.42) -- cycle;
\draw[cAmber!65!black, line width=0.28pt, opacity=0.38]
  (11.455, 2.35) .. controls (11.455, 1.85) and (11.185, 1.35) .. (10.885, 0.88);
\draw[cAmber!65!black, line width=0.28pt, opacity=0.38]
  (11.585, 2.35) .. controls (11.585, 1.85) and (11.315, 1.35) .. (11.015, 0.88);

% F-6 3 q_tr markers along polymer (shifted with polymer)
\foreach \cx/\cy in {11.45/2.00, 11.35/1.55, 11.20/1.10} {
  \node[circle, draw=cRed!85!black, fill=cRed!75!black, inner sep=0pt,
...
\draw[cRed!55!black, line width=0.30pt] (11.52, 2) -- (11.95, 2);
...
\node[font=\sffamily\bfseries\fontsize{7}{8.4}\selectfont, text=cRed!75!black,
      anchor=south east] at (10.3, 1.35) {Coulomb};
...
\node[labelMute, anchor=north east, font=\sffamily\fontsize{6.5}{7.8}\selectfont,
      text=cRed!75!black] at (10.3, 1.27) {repulsion};
...
\shade[left color=cGray!75!black, right color=cGray!40!black]
  (12.83, 0.4) rectangle (13, 2.6);
\draw[cGray!85!black, line width=0.50pt]
  (12.83, 0.4) rectangle (13, 2.6);
\draw[white, opacity=0.50, line width=0.35pt]
  (12.835, 0.45) -- (12.835, 2.55);
\foreach \ey in {0.70, 1.10, 1.50, 1.90, 2.30} {
  \draw[cGray!75!black, line width=0.28pt]
    (13.00, \ey) -- (13.15, {\ey+0.08});
}
\draw[cGray!70!black, fill=cGray!50!black, line width=0.35pt]
  (12.85, 0.35) -- (12.98, 0.35) -- (12.915, 0.22) -- cycle;
\draw[cGray!70!black, line width=0.28pt] (12.86, 0.2) -- (12.97, 0.2);
\draw[cGray!70!black, line width=0.28pt] (12.89, 0.16) -- (12.94, 0.16);
...
\node[labelMute, anchor=south, rotate=270,
      ...
      text=cGray!85!black] at (13.18, 1.5) {electrode};
