...
\shade[top color=cGray!12, bottom color=cGray!28, rounded corners=0.4pt]
  (6.225, 4.00) rectangle (6.875, 4.30);
\draw[cGray!55!black, line width=0.20pt, rounded corners=0.4pt]
  (6.225, 4.00) rectangle (6.875, 4.30);
% Dark glass display
\fill[cGray!85!black, rounded corners=0.2pt] (6.30, 4.21) rectangle (6.80, 4.28);
\draw[cGray!95!black, line width=0.12pt, rounded corners=0.2pt]
  (6.30, 4.21) rectangle (6.80, 4.28);
% Glowing pulse trace (bright cAmber on dark)
...
%
% (1) Front face — iter 38 Step 1: darker premium gradient + rounded corners.
\shade[top color=cGray!12, bottom color=cGray!28, rounded corners=0.4pt]
  (8.20, 3.55) rectangle (9.05, 4.05);
\draw[cGray!55!black, line width=0.20pt, rounded corners=0.4pt]
  (8.20, 3.55) rectangle (9.05, 4.05);
% (2) Dark glass display — iter 38: oscilloscope aesthetic (dark bg, glowing trace)
\fill[cGray!85!black, rounded corners=0.3pt] (8.25, 3.83) rectangle (9.00, 4.00);
\draw[cGray!95!black, line width=0.15pt, rounded corners=0.3pt]
  (8.25, 3.83) rectangle (9.00, 4.00);
% (4a) y-axis arrow — light cGray on dark screen
\draw[-{Stealth[length=2pt,width=1.6pt]}, cGray!30!white, line width=0.20pt]
  (8.30, 3.86) -- (8.30, 3.98);
% (4b) x-axis arrow — light cGray on dark screen
\draw[-{Stealth[length=2pt,width=1.6pt]}, cGray!30!white, line width=0.20pt]
  (8.30, 3.86) -- (8.92, 3.86);
% (4c) Glowing decay curve — bright cAmber trace on dark glass (oscilloscope)
\draw[cAmber!90!white, line width=0.45pt]
