...
\draw[cRed!80!black, line width=0.80pt] (0.65, 2.30) -- (3.85, 0.55);
\draw[cBlue!80!black, line width=0.80pt] (0.65, 2.30) -- (3.85, 1.50);
...
% D-7b curve ID labels — 2026-05-20 framework rewrite (briefing §8.4 + §13.5):
%   "deep-rich/shallow-rich" depolarization-framework naming → "high n / low n"
%   absorption-current framework. Paths updated to new D-5/D-6 curve coords.
%   `sloped` path-attached convention (iter 52d) retained for journal style.
%   RED = high n (sulfur polymer paper hero, steep, trap-rich).
%   BLUE = low n (control polymer, flat, trap-poor).
