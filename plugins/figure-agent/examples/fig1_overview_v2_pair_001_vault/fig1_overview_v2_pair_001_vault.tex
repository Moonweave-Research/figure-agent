...
% Panel-loop iter L11: shallow tone !75 → !80!black (parity with high/low n + Coulomb).
      text=cBlue!80!black, anchor=west] at (12.85, 7.45) {shallow};
\node[font=\sffamily\bfseries\fontsize{6.5}{7.8}\selectfont,
...
\draw[cGray!50, line width=0.35pt] (2.275, 4.85) -- (2.275, 4.55);
\draw[cGray!50, line width=0.35pt] (6.975, 4.85) -- (6.975, 4.55);
\draw[cGray!50, line width=0.35pt] (11.70, 4.85) -- (11.70, 4.55);
% Bridge: horizontal bracket connecting 3 verticals at y=4.85
\draw[cGray!50, line width=0.35pt] (2.275, 4.85) -- (11.70, 4.85);
% Convergent arrow: up from bracket center pointing TO caption text.
% iter PL3: arrow tip y 5.18 → 5.02 (just below caption baseline 5.05 with
% 0.03cm gap). Arrow points UP to caption — visual reading: "3 evidence (D/E/F)
% via bracket → converge on convergent evidence semantic gate".
\draw[-{Stealth[length=3pt,width=2.2pt]}, cGray!55!black, line width=0.40pt]
  (6.975, 4.85) -- (6.975, 5.02);
% Paper-context iter PL1: restore briefing §2 frame 5 "convergent evidence"
% semantic gate caption. Subtle 6pt italic cGray!60 placed ABOVE up arrow tip
% in inter-row gap, NOT bold dominant — integrated with bracket geometry as
% sub-label, satisfies both briefing requirement + user "less assertive" pref.
% Paper-context iter PL2: caption y 5.20 → 5.05 to clear Panel B "Sulfur
% content, wt%" axis label (baseline y=5.62, glyph bottom ~5.40). Previous y=5.20
% put caption top 5.34 just 0.06cm below Sulfur label — visually stacked.
% New y=5.05: caption glyph y range 5.05..5.19; Sulfur 5.40+ → 0.21cm gap.
\node[font=\sffamily\itshape\fontsize{6}{7.2}\selectfont, text=cGray!60!black,
      anchor=south, inner sep=0pt] at (6.975, 5.05) {convergent evidence};
% Modality labels (preserved): connector tier 6pt cGray!70 in inter-row gap
\node[font=\sffamily\fontsize{6}{7.2}\selectfont, text=cGray!70!black,
      anchor=north] at (2.275, 4.53) {kinetic};
\node[font=\sffamily\fontsize{6}{7.2}\selectfont, text=cGray!70!black,
      anchor=north] at (6.975, 4.53) {ISPD};
\node[font=\sffamily\fontsize{6}{7.2}\selectfont, text=cGray!70!black,
      anchor=north] at (11.70, 4.53) {mechanical};
...
\draw[cGray!22, line width=0.30pt, rounded corners=2pt]
  (0.05, 0.10) rectangle (13.85, 4.50);
\draw[cGray!22, line width=0.30pt] (4.62, 0.10) -- (4.62, 4.50);
\draw[cGray!22, line width=0.30pt] (9.47, 0.10) -- (9.47, 4.50);
...
\path[draw=none] (0.65, 2.30) -- (3.85, 0.55)
  node[pos=0.55, font=\sffamily\bfseries\itshape\fontsize{6.5}{7.8}\selectfont,
       text=cRed!80!black, sloped, above=6pt, inner sep=1pt]
  {high $n$};
