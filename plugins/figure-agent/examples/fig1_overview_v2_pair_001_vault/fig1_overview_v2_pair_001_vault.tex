...
\shade[top color=cGray!12, bottom color=cGray!58, rounded corners=1.8pt]
  (5.7, 4.1) rectangle (6.55, 4.4);
\draw[cGray!65!black, line width=0.22pt, rounded corners=1.8pt]
  (5.7, 4.1) rectangle (6.55, 4.4);
...
% Replaced abstract ⎓ bars with a digital readout "5 kV" inside display.
% Modern HV source instrument shows numeric value, not abstract glyph.
% Font: monospace digital-style (\ttfamily) in cAmber. Centered in display.
\node[font=\ttfamily\bfseries\fontsize{5.5}{6.6}\selectfont, text=cAmber!90!white]
  at (6.125, 4.30) {5 kV};
