...
% ============================================================
% Panel-loop iter L4-L5: modality label tier upgrade. italic 6pt → non-italic
% 6.5pt cGray!75!black (category label tier, parity with Row 1 setup labels).
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!75!black,
      anchor=west] at (0.45, 4.42) {kinetic};
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!75!black,
      anchor=west] at (5.05, 4.42) {ISPD};
\node[font=\sffamily\fontsize{6.5}{7.8}\selectfont, text=cGray!75!black,
      anchor=west] at (9.85, 4.42) {mechanical};
