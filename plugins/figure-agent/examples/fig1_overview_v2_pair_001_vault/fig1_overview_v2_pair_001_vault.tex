...
% Iter 18 (2026-05-23): user feedback — iter 17 anchor=west(4.72) placed
% the label so its tail 'film' word's last letter ended at TikZ x=5.95
% which crossed into the polymer slab (slab left x=5.90), making the 'm'
% sit on the cAmber gradient. Moved the label INSIDE the slab itself at
% slab x-center (6.675, 3.50) anchor=center — matches Panel D MIM 'polymer
% film' italic-on-slab convention. Leader + connector dot removed since
% label now sits on the labeled object.
\node[font=\sffamily\itshape\fontsize{6.5}{7.8}\selectfont,
      text=cGray!65!black,
      anchor=center] at (6.675, 3.525) {polymer film};
