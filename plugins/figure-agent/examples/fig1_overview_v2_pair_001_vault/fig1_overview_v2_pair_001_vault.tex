...
\fill[black, opacity=0.18, rounded corners=0.8pt] (5.86, 4.09) rectangle (6.51, 4.34);
\shade[top color=cGray!18, bottom color=cGray!50, rounded corners=0.8pt]
  (5.83, 4.12) rectangle (6.48, 4.37);
\draw[cGray!60!black, line width=0.25pt, rounded corners=0.8pt]
  (5.83, 4.12) rectangle (6.48, 4.37);
...
\fill[cGray!70!black, rounded corners=1pt] (5.87, 4.20) rectangle (6.44, 4.33);
\draw[cGray!85!black, line width=0.15pt, rounded corners=1pt]
  (5.87, 4.20) rectangle (6.44, 4.33);
...
% Panel E iter 30 [round 5 NC clean, 2026-05-27]: apparatus label typography unify.
% HV+: 5.5pt!75 -> 6pt!65. Matching V_s probe/V_s meter post-unify.
\node[font=\sffamily\fontsize{6}{7.2}\selectfont, text=cGray!65!black,
      anchor=east]
  at (5.55, 4.10) {HV+};
...
% Panel E iter 27 [round 5 NC clean, 2026-05-27]: ⊕ marker minimize.
% iter E7 radius 0.045 + bold 5.5pt "+" white glyph = "sticker" feel.
% NC convention surface charge: smaller flat circle outline + tiny "+",
% reads as schematic indicator not 3D marker. Radius 0.045→0.038, font
% 5.5→4.5pt, ball-shaded → flat cRed!65!black fill (matches Panel C trap
% dot subtle tier when not the focal point). Outline cRed!95!black 0.18pt.
\foreach \cx in {6.25, 6.60, 6.95, 7.30} {
  \fill[cRed!65!black] (\cx, 3.62) circle (0.038);
  \draw[cRed!95!black, line width=0.18pt] (\cx, 3.62) circle (0.038);
...
% iter 29: probe shaft outline 0.20 → 0.22pt (between secondary tier).
\draw[cGray!80!black, line width=0.22pt]
  (6.95, 3.87) -- (6.95, 4.05);
\draw[cGray!80!black, line width=0.22pt]
  (7.05, 3.87) -- (7.05, 4.05);
...
% iter30 follow-up: V_s probe 6.5pt -> 6pt (unified tier).
\node[font=\sffamily\fontsize{6}{7.2}\selectfont, text=cGray!65!black,
...
% iter30 follow-up: V_s meter 6.5pt!75 -> 6pt!65 (unified tier).
\node[font=\sffamily\fontsize{6}{7.2}\selectfont, text=cGray!65!black]
  at (8.14, 3.68) {$V_s$ meter};
