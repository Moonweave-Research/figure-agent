...
% ============================================================
% 2026-05-27 advisor-driven redesign: convergent evidence restored as 3 short
% vertical drops + inter-row modality labels. Spoke fan (b6d9672 removed) and
% inline panel-letter labels (iter L4-L5 packing) both retired in favor of:
%
%   3 vertical drops from Panel C bottom band to Row 2 frame top.
%   No diagonal V-fan, no stealth heads, no white-fill backdrop, no caption.
%   Drops carry "flow from above"; modality labels carry identity.
%
% Stroke 0.35pt cGray!50. Modality labels 6pt non-italic cGray!70 (connector
% tier, NOT bold category) in inter-row gap above panel letters.
