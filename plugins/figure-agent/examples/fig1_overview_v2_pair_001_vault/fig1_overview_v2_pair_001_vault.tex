...
\draw[cGray!55, line width=0.35pt] (6.975, 4.85) -- (6.975, 4.55);
...
% 0.03cm gap). iter PL6: weight 0.40 → 0.35pt parity with bracket strokes
% (cGray!50 throughout bridge structure).
\draw[-{Stealth[length=3pt,width=2.2pt]}, cGray!55!black, line width=0.35pt]
