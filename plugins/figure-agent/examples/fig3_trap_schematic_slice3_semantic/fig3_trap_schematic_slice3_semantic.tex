...
% Derived from immutable source/fig3_trap_schematic_v97.tex at eaed8fb1.
...
% =============================================================================
\newif\ifhybridstructuralorigin
\hybridstructuralorigintrue
\ifhybridstructuralorigin
\begin{scope}[shift={(6.00, 0.00)}]
  % SVG/PDF owns complex chain/domain/trap geometry only. TikZ retains the
  % 3x2 composition, panel letter, legend labels, and all inter-panel logic.
% figure-agent:start e.structural_origin_fragment
  \node[inner sep=0pt, anchor=center] at (3.00, 3.00)
      {\includegraphics[width=5.40cm,height=4.10cm]{fragments/structural_origin_fragment.pdf}};
% figure-agent:end e.structural_origin_fragment
  \node[font=\textsf{\fontsize{6.5}{8}\selectfont}, cGray, anchor=west]
      at (0.85, 0.78) {linear chain};
  \node[font=\textsf{\fontsize{6.5}{8}\selectfont}, cGray, anchor=west]
      at (3.65, 0.78) {trap site};
\end{scope}
\else
\begin{scope}[shift={(6.00, 0.00)}]
