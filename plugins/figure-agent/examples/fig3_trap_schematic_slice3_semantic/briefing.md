# Briefing — fig3_trap_schematic_slice3_semantic

> **Slice 3 derivative.** The byte-identical historical package is preserved
> under `source/` from commit `eaed8fb1`, tree `6966d9c`. Panel e delegates
> complex chain/domain/trap geometry to a semantic fragment. TikZ retains the
> six-panel composition and all text. The inherited briefing remains the
> scientific authority; machine validation is not publication acceptance.
