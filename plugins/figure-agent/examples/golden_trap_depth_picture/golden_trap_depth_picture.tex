...
\begin{scope}[shift={(3.15,6.15)}]
  ...
  \foreach \x in {0.458,0.917,1.833,2.292} {
    \draw[cGray, line width=0.15pt, dashed] (\x,0.36) -- (\x,2.38);
  }
  % major ticks
  \foreach \x in {0,1.375,2.75} {
    \draw[cGray, line width=0.25pt] (\x,0.36) -- (\x,0.30);
  }
  \foreach \x/\lab in {0/{10^-3},1.375/{10^0},2.75/{10^3}} {
    \node[tickLabel, anchor=north] at (\x,0.22) {$\lab$};
  }
  % minor grid lines (dashed)
  \foreach \y in {0.78,1.20,2.04} {
    \draw[cGray, line width=0.15pt, dashed] (0,\y) -- (2.75,\y);
  }
  % major ticks
  \foreach \y in {0.36,1.62,2.38} {
...
\begin{scope}[shift={(0.25,0.08)}]
  ...
  \foreach \x/\y in {2.35/2.40,3.65/2.40,4.82/2.40,5.30/2.40,5.88/2.40,3.08/1.78,4.60/1.78,5.05/1.78,5.50/1.78,2.35/1.08,3.80/1.08,4.50/1.08,5.20/1.08} {
