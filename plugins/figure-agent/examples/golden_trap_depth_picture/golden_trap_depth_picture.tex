...
\begin{scope}[shift={(7.30,6.02)}]
  ...
  \node[font=\sffamily\itshape\fontsize{6.5}{7.8}\selectfont, text=black] at (1.25,2.92) {Discharge (Debye reference)};
  ...
  \draw[evidenceArrow] (2.86,1.70) -- (5.40,1.70) -- (5.54,1.30);
\end{scope}
