...
\begin{scope}[shift={(0.25,0.08)}]
  ...
  % v0.3: schematic monomer-resolved chains (replaces 3 plot[smooth] + S \foreach)
  % S branch index map for 11-monomer schematic chain: middle chain carries the
  % S-rich segment; top/bottom chains stay sparse so the cluster reads clearly.
  \PolymerChain{1.65}{2.40}{11}{3,8}
  \PolymerChain{1.60}{1.78}{11}{2,6,7,8,9}
  \PolymerChain{1.60}{1.08}{11}{3,8}
