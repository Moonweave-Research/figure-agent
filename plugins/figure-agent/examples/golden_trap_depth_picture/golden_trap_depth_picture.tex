...
\begin{scope}[shift={(7.30,6.02)}]
  ...
  \node[align=left, text=cGray, font=\sffamily\itshape\fontsize{6.5}{7.8}\selectfont] at (0.62,1.08) {(Debye)};
...
\begin{scope}[shift={(0.25,0.08)}]
  ...
  \node[align=center, font=\sffamily\itshape\fontsize{5.6}{6.7}\selectfont, text=black, fill=white, inner sep=1.2pt] at (6.18,0.30) {chemical origin\\(electronegativity,\\polarizability of S)};
  ...
  \node[align=center, font=\sffamily\itshape\fontsize{5.6}{6.7}\selectfont, text=black, fill=white, inner sep=1.2pt] at (9.88,0.32) {physical origin\\(local potential\\fluctuations)};
...
\begin{scope}[shift={(12.62,1.95)}, xscale=0.90]
  ...
  \node[text=cAmber, font=\sffamily\itshape\fontsize{6.7}{8.0}\selectfont, anchor=west] at (5.16,3.80) {shallow};
  \node[text=cBlue!45!cRed, font=\sffamily\itshape\fontsize{6.7}{8.0}\selectfont, anchor=west] at (5.16,2.30) {deep};
\end{scope}
