...
quality_axes:
  ...
  label_annotation_semantics:
    ...
    evidence: "current render; visual_clash:VC001-VC020; print_178mm; C001 resolved"
    blocking_items: []
    recommended_action: none
  journal_polish:
    verdict: pass
...
journal_grade_assessment:
  ...
  assessed_artifact_hash: sha256:f499edf5664945e79c42ba7813b9d8c756181608e0a7baddde1a75bebe0f90c9
...
micro_defects:
  ...
  - {id: MD-VC012, crop: examples/fig2_charge_transport_mechanism/build/audit_crops/visual_clash/VC012_crop.png, kind: label_path_near_miss, severity: NIT, observation: "VC012 marks a positive pole inside a neutral dipole; the pole remains owned by its oval marker.", linked_finding_id: '', visual_clash_ref: VC012, text_boundary_ref: '', label_path_ref: '', undeclared_geometry_ref: '', status: accept_simplification, accept_simplification_reason: convention_acceptable, accept_simplification_rationale: "VC012 is convention acceptable: the positive pole is intentionally paired within a neutral dipole and does not assert source or carrier polarity."}
  ...
  - {id: MD-VC014, crop: examples/fig2_charge_transport_mechanism/build/audit_crops/visual_clash/VC014_crop.png, kind: label_path_near_miss, severity: NIT, observation: "VC014 marks a positive pole inside a neutral dipole; the pole remains owned by its oval marker.", linked_finding_id: '', visual_clash_ref: VC014, text_boundary_ref: '', label_path_ref: '', undeclared_geometry_ref: '', status: accept_simplification, accept_simplification_reason: convention_acceptable, accept_simplification_rationale: "VC014 is convention acceptable: the positive pole is intentionally paired within a neutral dipole and does not assert source or carrier polarity."}
  - {id: MD-VC015, crop: examples/fig2_charge_transport_mechanism/build/audit_crops/visual_clash/VC015_crop.png, kind: label_path_near_miss, severity: NIT, observation: "VC015 marks a negative pole inside a neutral dipole; the pole remains owned by its oval marker.", linked_finding_id: '', visual_clash_ref: VC015, text_boundary_ref: '', label_path_ref: '', undeclared_geometry_ref: '', status: accept_simplification, accept_simplification_reason: convention_acceptable, accept_simplification_rationale: "VC015 is convention acceptable: the negative pole is intentionally paired within a neutral dipole and does not assert source or carrier polarity."}
  - {id: MD-VC016, crop: examples/fig2_charge_transport_mechanism/build/audit_crops/visual_clash/VC016_crop.png, kind: label_path_near_miss, severity: NIT, observation: "VC016 marks a positive pole inside a neutral dipole; the pole remains owned by its oval marker.", linked_finding_id: '', visual_clash_ref: VC016, text_boundary_ref: '', label_path_ref: '', undeclared_geometry_ref: '', status: accept_simplification, accept_simplification_reason: convention_acceptable, accept_simplification_rationale: "VC016 is convention acceptable: the positive pole is intentionally paired within a neutral dipole and does not assert source or carrier polarity."}
  - {id: MD-VC017, crop: examples/fig2_charge_transport_mechanism/build/audit_crops/visual_clash/VC017_crop.png, kind: label_path_near_miss, severity: NIT, observation: "VC017 marks a negative pole inside a neutral dipole; the pole remains owned by its oval marker.", linked_finding_id: '', visual_clash_ref: VC017, text_boundary_ref: '', label_path_ref: '', undeclared_geometry_ref: '', status: accept_simplification, accept_simplification_reason: convention_acceptable, accept_simplification_rationale: "VC017 is convention acceptable: the negative pole is intentionally paired within a neutral dipole and does not assert source or carrier polarity."}
  - {id: MD-VC018, crop: examples/fig2_charge_transport_mechanism/build/audit_crops/visual_clash/VC018_J.png, kind: label_path_near_miss, severity: NIT, observation: "VC018 marks the J glyph in the mobile-current label; it is separated from the current arrow and remains readable.", linked_finding_id: '', visual_clash_ref: VC018, text_boundary_ref: '', label_path_ref: '', undeclared_geometry_ref: '', status: accept_simplification, accept_simplification_reason: false_positive, accept_simplification_rationale: "VC018 is a false positive: J_mob is a nearby variable label, not text crossing the current cue."}
  - {id: MD-VC019, crop: examples/fig2_charge_transport_mechanism/build/audit_crops/visual_clash/VC019_crop.png, kind: label_path_near_miss, severity: NIT, observation: "VC019 marks a positive pole inside a neutral dipole; the pole remains owned by its oval marker.", linked_finding_id: '', visual_clash_ref: VC019, text_boundary_ref: '', label_path_ref: '', undeclared_geometry_ref: '', status: accept_simplification, accept_simplification_reason: convention_acceptable, accept_simplification_rationale: "VC019 is convention acceptable: the positive pole is intentionally paired within a neutral dipole and does not assert source or carrier polarity."}
  - {id: MD-VC020, crop: examples/fig2_charge_transport_mechanism/build/audit_crops/visual_clash/VC020_crop.png, kind: label_path_near_miss, severity: NIT, observation: "VC020 marks a negative pole inside a neutral dipole; the pole remains owned by its oval marker.", linked_finding_id: '', visual_clash_ref: VC020, text_boundary_ref: '', label_path_ref: '', undeclared_geometry_ref: '', status: accept_simplification, accept_simplification_reason: convention_acceptable, accept_simplification_rationale: "VC020 is convention acceptable: the negative pole is intentionally paired within a neutral dipole and does not assert source or carrier polarity."}
crop_audit_log:
  ...
  - {crop_id: VC012_crop, path: build/audit_crops/visual_clash/VC012_crop.png, source: visual_clash:VC012, inspected: true, verdict: no_defect, linked_micro_defect_id: MD-VC012, rationale: "Positive pole is cleanly owned by its neutral dipole oval.", observed_objects: [positive pole, dipole oval], local_relationship: "Pole remains inside the marker and does not touch a source or transport path.", candidate_refs: [VC012], unintended_visible_anomaly: none, anomaly_rationale: "No anomaly visible.", anomaly_link: ''}
  ...
  - {crop_id: VC014_crop, path: build/audit_crops/visual_clash/VC014_crop.png, source: visual_clash:VC014, inspected: true, verdict: no_defect, linked_micro_defect_id: MD-VC014, rationale: "Positive pole is cleanly owned by its neutral dipole oval.", observed_objects: [positive pole, dipole oval], local_relationship: "Pole remains inside the marker and does not touch a source or transport path.", candidate_refs: [VC014], unintended_visible_anomaly: none, anomaly_rationale: "No anomaly visible.", anomaly_link: ''}
  - {crop_id: VC015_crop, path: build/audit_crops/visual_clash/VC015_crop.png, source: visual_clash:VC015, inspected: true, verdict: no_defect, linked_micro_defect_id: MD-VC015, rationale: "Negative pole is cleanly owned by its neutral dipole oval.", observed_objects: [negative pole, dipole oval], local_relationship: "Pole remains inside the marker and does not touch a source or transport path.", candidate_refs: [VC015], unintended_visible_anomaly: none, anomaly_rationale: "No anomaly visible.", anomaly_link: ''}
  - {crop_id: VC016_crop, path: build/audit_crops/visual_clash/VC016_crop.png, source: visual_clash:VC016, inspected: true, verdict: no_defect, linked_micro_defect_id: MD-VC016, rationale: "Positive pole is cleanly owned by its neutral dipole oval.", observed_objects: [positive pole, dipole oval], local_relationship: "Pole remains inside the marker and does not touch a source or transport path.", candidate_refs: [VC016], unintended_visible_anomaly: none, anomaly_rationale: "No anomaly visible.", anomaly_link: ''}
  - {crop_id: VC017_crop, path: build/audit_crops/visual_clash/VC017_crop.png, source: visual_clash:VC017, inspected: true, verdict: no_defect, linked_micro_defect_id: MD-VC017, rationale: "Negative pole is cleanly owned by its neutral dipole oval.", observed_objects: [negative pole, dipole oval], local_relationship: "Pole remains inside the marker and does not touch a source or transport path.", candidate_refs: [VC017], unintended_visible_anomaly: none, anomaly_rationale: "No anomaly visible.", anomaly_link: ''}
  - {crop_id: VC018_J, path: build/audit_crops/visual_clash/VC018_J.png, source: visual_clash:VC018, inspected: true, verdict: no_defect, linked_micro_defect_id: MD-VC018, rationale: "J_mob label is clear of the current arrow.", observed_objects: [J label, current arrow], local_relationship: "Variable label occupies a separate upper lane.", candidate_refs: [VC018], unintended_visible_anomaly: none, anomaly_rationale: "No anomaly visible.", anomaly_link: ''}
  - {crop_id: VC019_crop, path: build/audit_crops/visual_clash/VC019_crop.png, source: visual_clash:VC019, inspected: true, verdict: no_defect, linked_micro_defect_id: MD-VC019, rationale: "Positive pole is cleanly owned by its neutral dipole oval.", observed_objects: [positive pole, dipole oval], local_relationship: "Pole remains inside the marker and does not touch a source or transport path.", candidate_refs: [VC019], unintended_visible_anomaly: none, anomaly_rationale: "No anomaly visible.", anomaly_link: ''}
  - {crop_id: VC020_crop, path: build/audit_crops/visual_clash/VC020_crop.png, source: visual_clash:VC020, inspected: true, verdict: no_defect, linked_micro_defect_id: MD-VC020, rationale: "Negative pole is cleanly owned by its neutral dipole oval.", observed_objects: [negative pole, dipole oval], local_relationship: "Pole remains inside the marker and does not touch a source or transport path.", candidate_refs: [VC020], unintended_visible_anomaly: none, anomaly_rationale: "No anomaly visible.", anomaly_link: ''}
