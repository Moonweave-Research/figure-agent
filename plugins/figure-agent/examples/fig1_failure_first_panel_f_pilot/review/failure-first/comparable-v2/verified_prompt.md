...
- Write exactly one new source to [examples/fig1_failure_first_panel_f_pilot/review/failure-first/comparable-v2/verified_generated.tex].
- Do not create an intermediate subdirectory beneath [examples/fig1_failure_first_panel_f_pilot/review/failure-first/comparable-v2].
