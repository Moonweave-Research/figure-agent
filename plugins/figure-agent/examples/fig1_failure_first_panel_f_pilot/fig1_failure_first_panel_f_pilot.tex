...
% result-first mechanism scene: jig, applied-voltage cue, electrode, air gap,
% trapped-charge family, and Coulomb repulsion without invented circuit closure.
% ============================================================
...
% Compact applied-voltage state cue. Direct adjacency binds it to the electrode
% without inventing an instrument enclosure or circuit closure.
\node[anchor=south, fill=white, fill opacity=0.96, text opacity=1,
      inner xsep=0.85pt, inner ysep=0.38pt,
      font=\sffamily\bfseries\fontsize{5.0}{6.0}\selectfont, text=cBlue!72!black]
  at (13.30, 2.94) {$V_{\mathrm{app}}$};
