...
\node[anchor=east, fill=white, fill opacity=0.96, text opacity=1,
      inner xsep=0.75pt, inner ysep=0.32pt,
      font=\sffamily\bfseries\fontsize{4.7}{5.7}\selectfont, text=cBlue!72!black]
  at (12.54, 3.43) {$V_{\mathrm{app}}$};
