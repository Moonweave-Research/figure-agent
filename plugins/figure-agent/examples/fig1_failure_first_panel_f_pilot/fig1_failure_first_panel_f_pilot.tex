...
\begin{tikzpicture}[
  ...
  panelLetter/.style={font=\sffamily\bfseries\fontsize{8}{9.6}\selectfont,
                      text=cGray!90!black},
  panelFMechanicalAttachment/.style={cGray!62!black, line width=0.72pt,
                                     line cap=round, line join=round},
  panelFElectricalLead/.style={cBlue!70!black, line width=0.36pt,
...
% result-first mechanism scene: jig, compact grounded voltage source, driven
% electrode, floating sample, air gap, trapped charge, and Coulomb repulsion.
% ============================================================
\fill[white] (9.52, 0.18) rectangle (13.92, 4.34);
\draw[cGray!12, line width=0.25pt] (9.47, 0.14) -- (9.47, 4.36);

% figure-agent:start panel_f.mechanism_scene
% A small neutral mechanical jig is reduced to a fixed mechanical boundary:
% a rigid support rail, a short structural stem, and a shallow root jaw. The
% material and conductivity of the real holder remain deliberately unmodeled;
% the heavy neutral connector encodes mechanical attachment, never a wire.
% Rigid support rail with restrained fixed-boundary hatching.
\draw[panelFMechanicalAttachment] (11.58, 3.18) -- (12.10, 3.18);
\foreach \hx in {11.62,11.76,11.90,12.04} {
  \draw[cGray!48!black, line width=0.30pt]
    (\hx,3.18) -- ({\hx+0.07},3.26);
}
% Short structural stem connects the fixed rail to the shallow root jaw.
\draw[panelFMechanicalAttachment] (11.84,3.18) -- (11.84,2.98);
\fill[cGray!12, rounded corners=0.22mm]
  (11.68, 2.84) rectangle (12.00, 2.98);
\draw[panelFMechanicalAttachment, rounded corners=0.22mm]
  (11.68, 2.84) rectangle (12.00, 2.98);
\draw[cGray!56!black, line width=0.34pt]
  (11.72, 2.84) -- (11.72, 2.78);
\draw[cGray!56!black, line width=0.34pt]
  (11.96, 2.84) -- (11.96, 2.78);
...
\shade[left color=cGray!30, right color=cGray!16] (13.18, 0.46) rectangle (13.42, 2.82);
...
% Gap guides begin just beyond the curved cantilever edge at each height.
% They must not run behind the sample or charge markers, where they can be
% misread as electrical connectors or a plotting grid.
\foreach \yy/\xstart in {0.96/10.88,1.34/11.17,1.72/11.40,2.10/11.62} {
...
\node[labelMute, anchor=south, rotate=270, fill=white, fill opacity=0.96, text opacity=1,
      inner xsep=1.0pt, inner ysep=0.66pt,
      font=\sffamily\fontsize{5.2}{6.3}\selectfont, text=cGray!68!black]
  at (13.62, 1.62) {electrode};
\fill[white] (13.12, 0.10) rectangle (13.50, 0.23);

% Compact voltage source with explicit source-to-electrode lead and grounded
% source return. The sample and cantilever remain electrically floating: no
% electrical connector terminates on the jig, cantilever, or trapped charge.
\fill[cBlue!5, rounded corners=0.55mm] (12.60,3.24) rectangle (13.08,3.62);
\draw[cBlue!64!black, line width=0.38pt, rounded corners=0.55mm]
  (12.60,3.24) rectangle (13.08,3.62);
\node[font=\sffamily\bfseries\fontsize{4.4}{5.2}\selectfont,
      text=cBlue!70!black] at (12.84,3.43) {HV};

% Source-to-electrode lead (lower source terminal).
\fill[cBlue!70!black] (13.08,3.34) circle (0.025);
\draw[panelFElectricalLead]
  (13.08,3.34) -- (13.30,3.34) -- (13.30,2.82);
\node[anchor=south, fill=white, fill opacity=0.96, text opacity=1,
      inner xsep=0.75pt, inner ysep=0.32pt,
      font=\sffamily\bfseries\fontsize{4.4}{5.3}\selectfont, text=cBlue!72!black]
  at (12.84, 3.66) {$V_{\mathrm{app}}$};

% Grounded source return (upper source terminal); this ground belongs to the
% voltage source, never to the sample or cantilever.
\fill[cBlue!70!black] (13.08,3.52) circle (0.025);
\draw[panelFElectricalLead, cBlue!58!black, line width=0.34pt]
  (13.08,3.52) -- (13.58,3.52) -- (13.58,3.23);
\draw[cBlue!58!black, line width=0.34pt] (13.45,3.23) -- (13.71,3.23);
\draw[cBlue!58!black, line width=0.34pt] (13.49,3.17) -- (13.67,3.17);
\draw[cBlue!58!black, line width=0.34pt] (13.53,3.11) -- (13.63,3.11);

% Flat trapped-charge markers: consistent scientific symbols, not glossy beads.
...
\node[anchor=east, fill=white, fill opacity=0.94, text opacity=1,
      inner xsep=0.75pt, inner ysep=0.30pt,
      font=\sffamily\bfseries\fontsize{4.1}{4.9}\selectfont, text=cRed!68!black]
  at (11.48, 2.50) {trapped charge};
...
\node[labelMute, anchor=north west, fill=white, fill opacity=0.95, text opacity=1,
      ...
      text=cRed!70!black] at (9.62, 1.22) {repulsion};

\draw[<->, cGray!62!black, line width=0.42pt]
