...
% Shared motif semantics: a small neutral mechanical jig uses a rigid support rail,
% short structural stem, and shallow root jaw as a fixed mechanical boundary.
% Its compact voltage source shows $V_{\mathrm{app}}$, a
% source-to-electrode lead, and a grounded source return.
% The sample and cantilever remain electrically floating.
% Flat trapped-charge markers retain
% the fixture-local reading {trapped charge} while staying electrically isolated.
\PanelFFloatingCantilever{panelF}{11.84,2.84}
