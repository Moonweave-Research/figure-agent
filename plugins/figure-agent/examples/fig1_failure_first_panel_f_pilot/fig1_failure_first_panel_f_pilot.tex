...
\node[anchor=south, font=\sffamily\bfseries\fontsize{3.0}{3.6}\selectfont, text=cGray!46!black]
  at (13.02, 4.105) {$V_{\mathrm{active}}$};
\node[anchor=north, font=\sffamily\fontsize{2.7}{3.2}\selectfont, text=cGray!38!black]
  at (13.02, 3.80) {bias};
...
% A single understated metal contact sits on the cantilever root. It is a
% contact cue, not a clamp assembly and not evidence of an electrical return.
\shade[left color=cGray!34, right color=cGray!12, rounded corners=0.35mm]
  (11.72, 2.82) rectangle (11.96, 2.94);
...
% figure-agent:end panel_f.metal_contact
