...
- Write exactly one new source to [examples/fig1_updated_agent_redraw_v1/review/failure-first/comparable-v1/verified_generated.tex].
- Do not create an intermediate subdirectory beneath [examples/fig1_updated_agent_redraw_v1/review/failure-first/comparable-v1].
