...
\begin{scope}[shift={(0,4.75)}]
  ...
  \draw[-{Stealth[length=2.8pt,width=2.1pt]}, cRed!76!black, line width=0.44pt, dashed]
    (9.88,1.88) .. controls (10.36,2.28) and (10.43,2.98) .. (10.22,3.56);
  \node[small label, anchor=west, text=cGray!85!black] at (10.48,3.48) {thermal escape};
...
\begin{scope}[shift={(0,0)}]
  ...
  \draw[cGray!88!black, dash pattern=on 3pt off 2pt, line width=0.52pt]
    (0.86,1.88)--(1.70,1.88)
    .. controls (1.94,1.88) and (2.14,0.78) .. (2.34,0.56);
  ...
  \node[small label, text=cGray!88!black, anchor=west] at (2.40,0.60) {Debye};
\end{scope}
