...
% Q_clip label (locked negative charge)
\node[labelStrong, anchor=west, font=\sffamily\bfseries\fontsize{7.5}{9}\selectfont,
      text=cBlue!75!black, fill=cLGray!8, inner sep=1pt]
  at (6.50, 4.27) {$Q_{\mathrm{clip}} = -CV_0$ (locked)};
