...
\fill[cLGray!8, rounded corners=3mm] (-0.10, -0.10) rectangle (14.10, 9.45);

% Panel letters
\node[panelLetter, anchor=north west] at (0.10, 9.40) {A};
...
% Clip status annotation (lifted above phase letters to avoid vertical collision;
%  v3: previously at y=8.80 overlapping phase-letter band; now at y=9.10)
\node[labelMute, anchor=south, font=\sffamily\fontsize{5.5}{6.6}\selectfont,
      text=cGray!75!black, fill=cLGray!18, inner sep=1pt]
  at (1.60, 9.10) {clip: \textbf{GROUNDED}};
\node[labelMute, anchor=south, font=\sffamily\fontsize{5.5}{6.6}\selectfont,
      text=cGray!75!black, fill=cAmber!05, inner sep=1pt]
  at (7.90, 9.10) {clip: FLOATING (Q$_{\mathrm{clip}}$ locked)};
...
% Panel B internal title (v3: moved from y=5.10 to y=5.45 — Q_clip chip at y=4.72
%  with anchor=south + fill extends up to ~y=5.02 and was occluding the title)
\node[labelMute, anchor=north, font=\sffamily\itshape\fontsize{6.5}{7.8}\selectfont,
      text=cGray!75!black] at (7.00, 5.45) {Phase D snapshot: V$_{\mathrm{active}} = -V_0$, locked Q$_{\mathrm{clip}}$ same sign $\Rightarrow$ Coulomb repulsion};
...
% v3: arrow base moved from (6.20, ..) — was inside clip rect (5.85..6.35) — to clip's right edge
\draw[forceArrow, cRed!85!black]
  (6.37, 4.27) -- (7.50, 4.27);
% v3: F_Coulomb label lifted from y=4.32 to y=4.45 (anchor=south west) so the
%  arrow line at y=4.27 no longer strikes through the text baseline.
\node[labelStrong, anchor=south west, font=\sffamily\bfseries\fontsize{7}{8.4}\selectfont,
      text=cRed!75!black] at (7.55, 4.32) {$F_{\mathrm{Coulomb}}$};
\node[labelMute, anchor=north west, font=\sffamily\fontsize{6}{7.2}\selectfont,
      text=cRed!75!black] at (7.55, 4.20) {(repulsion: $Q_{\mathrm{clip}} \cdot E_{\mathrm{active}}$)};
