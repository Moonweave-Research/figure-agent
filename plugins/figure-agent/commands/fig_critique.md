...
4. Use the **Write** tool to create `examples/<name>/critique.md` with this exact format (YAML front-matter then Markdown body — schema v1.8):
...
rubric_version: figure-agent.critique-rubric.v1.8
