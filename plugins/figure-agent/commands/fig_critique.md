...
4. Use the **Write** tool to create `examples/<name>/critique.md` with this exact format (YAML front-matter then Markdown body — schema v1.9):
...
micro_defects:
  - id: M001
    ...
    kind: line_crosses_label | wire_crosses_label | arrow_tip_fused | label_target_detached | floating_semantic_cue | drawing_order_suspect | print_scale_unreadable | label_backdrop_overflows_outline | label_glyph_overlaps_internal_drawing
    severity: BLOCKER | MAJOR | MINOR | NIT
