...
**Usage**: `/fig_drive <name> --mode <mode> --goal "<goal>" --dry-run [--json | --format json]`
...
`--format json` are accepted as compatibility no-ops for operators who use them
on other figure-agent commands.
