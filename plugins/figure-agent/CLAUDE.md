...
This repo is a Claude Code plugin. Authoritative workflow: `skills/figure-agent/SKILL.md`. Active product direction and execution order: `../../FIGURE_AGENT_SPEC.md`. `docs/quality-kernel-goal.md` is historical rationale and current quality-kernel mechanics.
...
- Convert PNG → SVG/TikZ automatically (see `docs/quality-kernel-goal.md` for rationale).
...
- v0.2 quality-kernel rationale: `docs/quality-kernel-goal.md`; integrated product direction: `../../FIGURE_AGENT_SPEC.md`.
