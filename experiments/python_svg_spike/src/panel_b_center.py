...
def add_math_labels(drawing: draw.Drawing) -> None:
    ...
    drawing.append(math_svg(r"g(E_t)", x=378, y=148, width=52, prefix="b_top_g", color="#111111"))
    drawing.append(math_svg(r"g(E_t)", x=378, y=498, width=58, prefix="b_axis_g", color="#111111"))
    drawing.append(math_svg(r"E_t", x=516, y=360, width=20, prefix="b_et_small", color="#111111"))
